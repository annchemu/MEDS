      ...
      document.getElementById('weight_sample_one_three').value = s_weight_one.toFixed(5);
      document.getElementById('weight_sample_two_three').value = s_weight_two.toFixed(5);
      document.getElementById('weight_sample_three_three').value = s_weight_three.toFixed(5);
      document.getElementById('weight_sample_four_three').value = s_weight_four.toFixed(5);
      document.getElementById('weight_sample_five_three').value = s_weight_five.toFixed(5);
      ...
      var a=samples_relative_retention_time.length;
     ...
     $(document).ready(function(){
      ...
      document.getElementById('sample_one_average').value = average.toFixed(5);
      ...
      document.getElementById('sample_two_average').value = average.toFixed(5);
      ...
      document.getElementById('sample_three_average').value = average.toFixed(5);
      ...
      document.getElementById('sample_four_average').value = average.toFixed(5);
      ...
      document.getElementById('sample_five_average').value = average.toFixed(5);
      ...
      document.getElementById('sample_six_average').value = average.toFixed(5);
      ...
      if(min_tolerance < lowest_value || min_tolerance > highest_value || min_tolerance==0 || min_tolerance==""){
            comment_a= "Not Ok";
      }else{
            comment_a="OK";
      }
      ...
      if(max_tolerance < lowest_value || max_tolerance > highest_value){
            comment_b= "Not Ok";
      }else{
            comment_b="OK";
      }
