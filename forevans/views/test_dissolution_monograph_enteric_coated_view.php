...
<?php echo validation_errors(); ?>
      <?php echo form_open('test_dissolution/save_enteric_coated_monograph',array('id'=>'save_enteric_coated_monograph'));?>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                Enteric Coated Tablets: Single COmponent HPLC Monograph Details
              </td>
            </tr>
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                <textarea rows="15" cols="180" name="enteric_coated_monograph"></textarea>
              </td>
            </tr>
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
            ...
            <tr>
                <td  height="25px" style="padding:4px;background-color:#ffffff;border-top: solid 1px #bfbfbf;text-align: center;" colspan="8" ><input class="btn" type="submit" name="save_enteric_coated_monograph" id="save_enteric_coated_monograph" value="Submit"></td>
            </tr>
       </table>
      </form>
