...
<div id="forms">
  <?php echo validation_errors(); ?>
      <?php echo form_open('test_identification/save_thin_layer_monograph',array('id'=>'assay_view'));?>
       ...
       <table class="table_form" width="75%" border="0" cellpadding="4px" align="center">
          ...
          <tr>
           ...
           <td colspan ="6">
            ...
            <tr>
              <td colspan="8" align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>Identification Monograph Details</h5></td>
            </tr>
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                Thin Layer Chromatography Monograph Details
              </td>
            </tr>
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                <textarea rows="15" cols="180" name="thin_layer_monograph"></textarea>
              </td>
            </tr>
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
            ...
            <tr>
                <td  height="25px" style="padding:4px;background-color:#ffffff;border-top: solid 1px #bfbfbf;text-align: center;" colspan="8" ><input class="btn" type="submit" name="save_thin_layer_monograph" id="save_thin_layer_monograph" value="Submit"></td>
            </tr>
       </table>
      </form>
