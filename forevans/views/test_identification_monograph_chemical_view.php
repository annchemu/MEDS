...
<div id="forms">
   <?php echo validation_errors(); ?>
      <?php echo form_open('test_identification/save_chemical_monograph',array('id'=>'assay_view'));?>
           ...
           <td colspan ="6">
            ...
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                Chemical Method Monograph Details
              </td>
            </tr>
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                <textarea rows="15" cols="180" name="chemical_monograph"></textarea>
              </td>
            </tr>
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
            ...
            <tr>
                <td  height="25px" style="padding:4px;background-color:#ffffff;border-top: solid 1px #bfbfbf;text-align: center;" colspan="8" ><input class="btn" type="submit" name="save_chemical_monograph" id="save_chemical_monograph" value="Submit"></td>
            </tr>
       </table>
      </form>
