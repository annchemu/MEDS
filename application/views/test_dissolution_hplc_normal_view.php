    ...
    <tr>
      ...
      <tr>
       ...
       <tr>
        ...
        <td colspan ="4"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="standard_container" id ="standard_container"> </td>
      </tr>
       <tr>
        ...
        <td colspan ="4"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="container" id ="container"> </td>
       </tr>
       <tr>
      ...
      <tr>
        ...
        <td colspan ="4"align="left"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="flow_rate"> ml/min</td>       
      </tr>
      <tr>
        ...
        <td colspan ="6">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">       
            ...
            <tr>
              ...
              <td style="padding: 8px;"><input id = "rt_rsd" type = "text" name ="rt_rsd"></td>
              <td style="padding: 8px;"><input id = "peak_area_rsd" type = "text" name ="peak_area_rsd"></td>
              <td style="padding: 8px;"><input id = "asymmetry_rsd" type = "text" name ="asymmetry_rsd"></td>
              <td style="padding: 8px;"><input id = "resolution_rsd" type = "text" name ="resolution_rsd"></td>
              <td style="padding: 8px;"><input id = "other_rsd" type = "text" name ="other_rsd" id ="other_rsd"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 8px;"><input type = "text" name ="peak_area_comment" id ="peak_area_comment"></td>
              <td style="padding: 8px;"><input type = "text" name ="asymmetry_comment" id ="asymmetry_comment"></td>
              <td style="padding: 8px;"><input type = "text" name ="resolution_comment" id ="resolution_comment"></td>
