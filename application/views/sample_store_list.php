...
<?php
  ...
  <div id="form_wrapper_lists">
      ...
      <td style ="text-align:center; color:blue;"><b>Standard Temperature Limit: 9 to 25C</b></td>
	...
	<tbody>
               ...
               <tr>
                  ...
                  <td>
                     <a href=" <?php echo base_url().'temperature_humidity_details/Get/'.$row->ht_id;?>">Edit</a>&nbsp;&nbsp;
                     <a href=" <?php echo base_url().'temperature_humidity_log/Logs/'.$row->ht_id;?>">Log</a>
                  </td>
               <?php $i++; ?>
               </tr>
	    <?php endforeach; ?>
