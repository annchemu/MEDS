            ...
            <table border="0" align="center" cellpadding="8px" width="100%" >
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" height="25px" style="padding:4px;border-bottom:solid 1px #bfbfbf;text-align:left;background-color:#ffffff;border-right:solid 1px #bfbfbf;"><?php echo $assay_monograph_hplc_area_method_two_components[0]['serial_number']?></td>
            ...
            <td colspan="8" style="padding:8px;border-bottom:dotted 1px #c4c4ff;">
              <table class="inner_table" width="80%" border="0" align="center" cellpadding="8px"> 
                ...
                <tr>
                    ...
                    Weight of container(g)</td>
                    <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    <input type="text" name="weight_container_one" id="weight_container_one" onChange="calculate_difference()"></td>
                    <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    <input type="text" name="weight_container_two" id="weight_container_two" onChange="calculate_difference()"></td>
                ...
                <tr>
                    ...
                    <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    <input type="text" name="weight_standard_one" id="weight_standard_one" onChange="calculate_difference()"></td>
                    <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    <input type="text" name="weight_standard_two" id="weight_standard_two" onChange="calculate_difference()"></td>
                    
                </tr>
                <tr>
                  <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: solid 1px #c4c4ff;background-color: #ffffff;">Dilution:</td>
                  <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: solid 1px #c4c4ff;background-color: #ffffff;"><textarea type="text" name="dilution_one" row="4" cols="40"></textarea></td>
                  <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: solid 1px #c4c4ff;background-color: #ffffff;"><textarea type="text" name="dilution_two" row="4" cols="40"></textarea></td>
                </tr>
              </table>
            </td>
          </tr>
              ...
              <td colspan="8" align="center">
                ...
                <table class="table_form" width="90%" align="center" cellpadding="8px">
                    ...
                    <tr>
                        ...
                        <td  height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_container_six_one" id="weight_sample_container_six_one"></td>
                    ...
                    <tr>
                        ...
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_container_six_two" id="weight_container_six_two" onChange="calculate_difference()"></td>
                    ...
                    <tr>
                        ...
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_six_three" id="weight_sample_six_three" onChange="calculate_difference()"></td>
