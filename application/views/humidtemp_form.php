   ...
   <div id="freezer" name="menu" style="display:block;">
    ...
    <input type="hidden" name ="user" value ="<?php echo($user['logged_in']['fname']." ".$user['logged_in']['lname']);?>">
      ...
      <td colspan ="6" align ="center" style="text-align:center;background-color:#ffffff;padding-right:40px;border-bottom: solid 10px #f0f0ff;color: #000000;background-color: #e8e8ff;">
        <h4>Standard Temperature Limit: -20 (+/-3)</h4>
      </td>
    </tr>
		<tr>
      ...
      <td style="background-color:#ffffff;border-right: dotted 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">
        ...
        <span id="standard_min_temp_r" style="color:white;background-color:red;padding:4px;display:none">field required</span></td>
			...
			<td style="background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Minimum Temperature Corrected
			</td>
			<td style="background-color:#ffffff;border-right: dotted 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">
      ...
      <td style="background-color:#ffffff;border-right: dotted 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type ="text" id="max_temp"  name ="max_temp" class ="fieldfreezer"><span id="max_temp_g" style="color:Green; display:none"><img src="<?php echo base_url().'images/done.png';?>" height="10px" width="10px"></span><span id="max_temp_r" style="color:white;background-color:red;padding:4px;display:none">field required</span></td>
			...
			<td style="background-color:#ffffff;border-right: dotted 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type ="text" id="max_temp_corrected" name ="max_temp_corrected"></td>
    </tr>
		<tr>
			<td colspan="6" style="text-align:center;background-color:#ffffff;border-right: dotted 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;"><input type = "submit" name ="save_humidtemp" id ="save_freezer_humidtemp"value ="Submit"></td>
		</tr>
       ...
       <div id="sample_store" name="menu" style="display:none;"><?php include_once "application/views/sample_store_form.php";?></div>
       <div id="laboratory_area" name="menu" style="display:none;"><?php include_once "application/views/laboratory_area_form.php";?></div>  
       <div id="instrument_room" name="menu" style="display:none;"><?php include_once "application/views/instrument_room_form.php";?></div>
       <div id="refrigerator_form" name="menu" style="display:none;"><?php include_once "application/views/refrigerator_form.php";?></div>
</body>		
</html>