        ...
        <table  class="subdivider" border="0" bgcolor="#ffffff"  width="100%" cellpadding="8px" align="center">
          <tr>
            ...
            <tr>
                ...
                <a href="<?php echo base_url().'standard_register_records/getDamaged';?>" class="current sub_menu sub_menu_link first_link">Damaged Records</a>
                <a href="<?php echo base_url().'standard_register_records/getExhausted';?>" class="sub_menu sub_menu_link first_link">Exhausted Records</a>
                </td>
                <td align = "right"
                    <?php
