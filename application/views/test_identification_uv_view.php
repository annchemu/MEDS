 ...
 <head>
  ...
  <script>
   ...
   function sample_weight_calc(){
       ...
       function reagent_weight_calc(){
        var total = document.getElementById('reagent_container').value - document.getElementById('container_4').value;
        document.getElementById('reagent_weight').value = total;
       }
       function reagent_weight_calc_2(){
        var total = document.getElementById('reagent_container_2').value - document.getElementById('container_5').value;
        document.getElementById('reagent_weight_2').value = total;
       }
       function reagent_weight_calc_3(){
        var total = document.getElementById('reagent_container_3').value - document.getElementById('container_6').value;
        document.getElementById('reagent_weight_3').value = total;
       }
       function reagent_weight_calc_4(){
        var total = document.getElementById('reagent_container_4').value - document.getElementById('container_7').value;
        document.getElementById('reagent_weight_4').value = total;
       }
    ...
    <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_sample_container" id="sample_container"> </td>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_container" id ="container" onchange ="sample_weight_calc()"> </td>
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of sample (g)</td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_sample_weight_1" id ="sample_weight"> </td>
      </tr>
      <tr>  
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Dilution</td>    
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><textarea rows ="4" cols ="50" name ="uv_sample_dilution"></textarea> </td>
      </tr>
      <tr> 
      ...
      <tr>
        ...
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
          <select id="uv_standard_description" name="uv_standard_description" >
      ...
      <tr>
        ...
        <td colspan = "" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency"> </td>
        ...
        <td colspan = "" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_lot_no"> </td>
        ...
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_id_no"> </td>
      </tr>
       <tr>
        ...
        <td colspan =" "style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency_standard_container" id="standard_container_2"> </td>
        <td colspan ="2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency_standard_container_2" id="standard_container_3"> </td>
        </tr>
       <tr>
        ...
        <td colspan =" "style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency_container" id ="container_2" onchange="standard_weight_calc()" > </td>
        <td colspan ="2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency_container_2" id ="container_3" onchange="standard_weight_calc_2()" > </td>
       </tr>
       <tr>
        ...
        <td colspan =" "style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_standard_weight" id ="standard_weight_2"> </td>
        <td colspan ="2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_standard_weight_2" id ="standard_weight_3"> </td>
      </tr>
      <tr>  
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Dilution</td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea rows ="4" cols ="50" name ="uv_standard_dilution"></textarea></td>
      </tr> 
      <tr> 
        <td align="left"colspan ="6" style="padding: 8px;padding: 8px;background-color: #e8e8ff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:0000fb;"><b>Reagents</b> </td>
      </tr> 
       <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency_reagent_container" id="reagent_container"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency_reagent_container_2" id="reagent_container_2"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency_reagent_container_3" id="reagent_container_3"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_potency_reagent_container_4" id="reagent_container_4"> </td>
        </tr>
       <tr>
        <td colspan ="2"align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of container (g) </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_reagent_container" id ="container_4" onchange="reagent_weight_calc()" > </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_reagent_container_2" id ="container_5" onchange="reagent_weight_calc_2()" > </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_reagent_container_3" id ="container_6" onchange="reagent_weight_calc_3()" > </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_reagent_container_4" id ="container_7" onchange="reagent_weight_calc_4()" > </td>
       </tr>
       <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_reagent_weight" id ="reagent_weight"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_reagent_weight_2" id ="reagent_weight_2"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_reagent_weight_3" id ="reagent_weight_3"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="uv_reagent_weight_4" id ="reagent_weight_4"> </td>
      </tr>     
      <tr>
        ...
        <td colspan = "3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><textarea cols ="50" rows="3" name="acceptance_criteria"></textarea> </td>
        ...
        <td colspan = "3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea cols ="50" rows="3" name="uv_results"></textarea> </td>  
      </tr>
      <tr>      
        ...
        <td colspan = "7"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea cols ="90" rows="3" name="uv_comment"></textarea> </td>
      </tr>
     <tr>
      ...
      <tr>
        <td colspan = "6" align ="center"> <input type ="submit" name ="save_uv_identification" value ="Save Identification Data"></td>
      </tr>
    </table>
   </form> 
  </div>
