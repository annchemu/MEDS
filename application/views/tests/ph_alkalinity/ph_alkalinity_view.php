  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <div id="form_wrapper">
     <div id="forms">
      ...
      <?php echo form_open('ph_alkalinity/save',array('id'=>'ph_alkalinity_view'));?>
        ...
        <tr>
          <td colspan="8" align="center" style="padding:8px;">
            <table border="0" align="center" cellpadding="8px" width="100%" >
              ...
              <tr>
                <td colspan="6" height="25px" align="center" style="padding:8px;border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>PH Alkalinity Test</h5></td>
              </tr>
              <tr>
                <td colspan="6" style="padding:9px;">
                  <table width="100%">
                      <tr>
                          <td  height="20px" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                          Method</td>
                          <td  colspan="5" height="25px" align="left" style="padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                          <input type="text" name="method" size="100"></td>
                      </tr>
                      <tr>
                          <td  colspan="6" height="20px" align="left" style="padding:4px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                          Observation</td>
                          
                      </tr>
                      <tr>
                          <td  colspan="6" height="25px" align="center" style="padding:8px;border-bottom: dotted 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                          <textarea cols="180" rows="15" name="observation"></textarea></td>
                      </tr>
                  </table>
                </td>
              </tr>
