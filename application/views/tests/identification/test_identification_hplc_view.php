...
<table width="950" class ="table_form" border="0" cellpadding="4px" align="center">
   <input type="hidden" name ="assignment" value ="<?php echo $assignment;?>"><input type="hidden" name ="test_request" value ="<?php echo $test_request;?>">
    ...
    <tr>
        <td colspan = "2"align="center" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of sample + container (g)</td>
    ...
    <tr>  
        <td colspan = "2"align="center" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of sample (g)</td>
      ...
      <tr>  
        <td colspan = "4" align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Dilution</td>
    </tr>
    <tr>
        <td colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea rows="4" cols="80"  name = "sample_dilution"></textarea></td>
      </tr>   
       ...
       <tr>
        <td colspan = "6" align ="center"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><textarea rows="4" cols="80"  name = "standard_weight"></textarea></td>
      </tr>
      <tr>  
      ...
      <tr>
        <td align="left" colspan = "" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><b>Standard Description:</b></td>
        <td colspan = "2" align="right"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
        ...
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
          <select id="standard_description_2" name="uv_standard_description" >
              <option selected></option>
               <?php
               foreach($sql_standards as $s_name):
              ?>
               
               <option value="<?php  echo $s_name['item_description'];?>" data-idnotwo="<?php  echo $s_name['reference_number'];?>" data-lotnotwo="<?php  echo $s_name['batch_number'];?>"data-potencytwo="<?php  echo $s_name['potency'];?>"><?php  echo $s_name['item_description'];?></option>
                <?php
                endforeach
                ?>
            </select>
      ...
      <tr>
        ...
        <td colspan = ""style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">  <input type = "text" name = "potency_2" id="potency_2"></td>
      </tr>
      <tr> 
        <td align="center" colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Lot No.: </td><td><input type = "text" name = "lot_no" id="lot_no"></td>
        <td style="padding: 8px;border-bottom: dotted 1px #bfbfbf;"><input type = "text" name = "lot_no_2" id="lot_no_2"></td>
      </tr>
      <tr> 
        <td align="center" colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">ID No.:</td><td> <input type = "text" name = "id_no" id="id_no"></td>
        <td style="padding: 8px;border-bottom: dotted 1px #bfbfbf;"><input type = "text" name = "id_no_2" id="id_no_2"></td>
      </tr>
       <tr>
        <td align="center" colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of standard + container (g)</td>
        <td align="right"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type = "text" name = "standard_container" id ="standard_container"></td>
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type = "text" name = "standard_container_2" id ="standard_container_2"></td>
       </tr>        
      <tr>  
        <td align="center" colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of container (g) </td>
        <td align="right"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type = "text" name = "container_1" id ="container"></td>
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type = "text" name = "container_2" id ="container_2"></td>
      </tr>        
      <tr> 
        <td align="center" colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of standard (g)</td>
        <td align="right"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type = "text" name = "standard_weight_1" id ="standard_weight_1"></td>
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><input type = "text" name = "standard_weight_2" id ="standard_weight_2"></td>
      </tr>        
      <tr>
      ...
      <tr>
        <td align="left" colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color: #0000fb;" ><b>Reagents</b> </td>
      </tr> 
      <tr>
        <td colspan="2"align="center" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;">Reagents Description:</td>
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;">Reagents 1:</td>
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;">Reagents 2:</td>
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;">Reagents 3:</td>
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;">Reagents 4:</td>
      ...
      <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
          <select id="reagent_1" class ="reagent"  name="reagents" width ="10">
              <option selected></option>
               <?php
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
          <select id="reagent_1" class ="reagent"  name="reagents_2" width ="10">
              <option selected></option>
               <?php
               foreach($sql_reagents as $s_name):
              ?>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
          <select id="reagent_1" class ="reagent"  name="reagents_3" width ="10">
              <option selected></option>
               <?php
               foreach($sql_reagents as $s_name):
              ?>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">          
          <select id="reagent_1" class ="reagent"  name="reagents_4" width ="10">
              <option selected></option>
               <?php
               foreach($sql_reagents as $s_name):
              ?>
       ...
       <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type = "text" name = "reagent_weight_container_2" id ="reagent_weight_container_2"></td>          
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type = "text" name = "reagent_weight_container_3" id ="reagent_weight_container_3"></td>         
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type = "text" name = "reagent_weight_container_4" id ="reagent_weight_container_4"></td> 
      </tr>
      <tr>
        <td colspan="2"align="center" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of container (g) </td>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type = "text" name = "reagent_container_2" id ="reagent_container_2"></td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type = "text" name = "reagent_container_3" id ="reagent_container_3"></td>
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type = "text" name = "reagent_container_4" id ="reagent_container_4"> </td>
      </tr>
      <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type = "text" name = "reagent_weight_3" id ="reagent_weight_3"></td>
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type = "text" name = "reagent_weight_4" id ="reagent_weight_4"></td>
      <tr>
       ...
       <tr>
        <td colspan = "6"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><textarea cols="80" rows="4" name = "mobile_phase" ></textarea></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan ="6">
          ...
          <tr>
            <td align="center" style="padding: 8px;">No.</td>
            <td align="center" style="padding: 8px;">Retention Time (minutes)</td>
            <td align="center" style="padding: 8px;">Peak Area</td>
            <td align="center" style="padding: 8px;">Asymmetry</td>
            <td align="center" style="padding: 8px;">Resolution</td>
            <td align="center" style="padding: 8px;"><input type = "text" name ="other_type_1" id ="other_type" placeholder ="Other tpyes"></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">1.</td>
            <td style="padding: 8px;"><input type = "text" name ="rt_1" class ="rt" id ="rt_1" ></td>
            <td style="padding: 8px;"><input type = "text" name ="peak_area_1" class="peak_area" id ="peak_area_1" ></td >
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_1" class="asymmetry" id="asymmetry_1" ></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_1" class="resolution" id ="resolution_1" ></td>
            <td style="padding: 8px;"><input type = "text" name ="other_1" id ="other_1" ></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">2.</td>
            <td style="padding: 8px;"><input type = "text" name ="rt_2" class ="rt" id ="rt_2" ></td>
            <td style="padding: 8px;"><input type = "text" name ="peak_area_2" class="peak_area" id ="peak_area_2" ></td>
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_2" class="asymmetry" id="asymmetry_2" ></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_2" class="resolution" id ="resolution_2" ></td>
            <td style="padding: 8px;"><input type = "text" name ="other_2" id ="other_2" ></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">3.</td>
            <td style="padding: 8px;"><input type = "text" name ="rt_3" class ="rt" id ="rt_3" ></td>
            <td style="padding: 8px;"><input type = "text" name ="peak_area_3" class="peak_area" id ="peak_area_3" ></td>
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_3" class="asymmetry" id="asymmetry_3" ></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_3" class="resolution" id ="resolution_3" ></td>
            <td style="padding: 8px;"><input type = "text" name ="other_3" id ="other_3" ></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">4.</td>
            <td style="padding: 8px;"><input type = "text" name ="rt_4" class ="rt" id ="rt_4" ></td>
            <td style="padding: 8px;"><input type = "text" name ="peak_area_4" class="peak_area" id ="peak_area_4" ></td>
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_4" class="asymmetry" id="asymmetry_4" ></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_4" class="resolution" id ="resolution_4" ></td>
            <td style="padding: 8px;"><input type = "text" name ="other_4" id ="other_4" ></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">5.</td>
            <td style="padding: 8px;"><input type = "text" name ="rt_5" class ="rt" id="rt_5" ></td>
            <td style="padding: 8px;"><input type = "text" name ="peak_area_5" class="peak_area" id ="peak_area_5" ></td>
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_5" class="asymmetry" id="asymmetry_5" ></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_5" class="resolution" id ="resolution_5" ></td>
            <td style="padding: 8px;"><input type = "text" name ="other_5" id ="other_5" ></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">6.</td>
            <td style="padding: 8px;"><input type = "text" name ="rt_6" class ="rt" id="rt_6"></td>
            <td style="padding: 8px;"><input type = "text" name ="peak_area_6" class="peak_area" id ="peak_area_6" ></td>
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_6" class="asymmetry" id ="asymmetry_6" ></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_6" class="resolution"id ="resolution_6"></td>
            <td style="padding: 8px;"><input type = "text" name ="other_6" id ="other_6" ></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">Average</td>
            <td style="padding: 8px;"><input type = "text" name ="rt_avg" class ="rt_avg" id ="rt_avg"></td>
            <td style="padding: 8px;"><input type = "text" name ="peak_area_avg" class="peak_area_avg" id ="peak_area_avg" ></td>
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_avg" class="asymmetry_avg" id="asymmetry_avg"></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_avg" class="resolution_avg" id ="resolution_avg"></td>
            <td style="padding: 8px;"><input type = "text" name ="other_avg" id ="other_avg"></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">SD</td>
            <td style="padding: 8px;"><input type = "text" name ="rt_sd" class ="rt_sd" id ="rt_sd"></td>
            <td style="padding: 8px;"><input type = "text" name ="peak_area_sd" class="peak_area_sd" id ="peak_area_sd"></td>
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_sd" class="asymmetry_sd" id ="asymmetry_sd"></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_sd" class="resolution_sd" id ="resolution_sd"></td>
            <td style="padding: 8px;"><input type = "text" name ="other_sd" id ="other_sd"></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">RSD</td>
            <td style="padding: 8px;"><input type = "text" id = "rt_rsd" name ="rt_rsd"></td>
            <td style="padding: 8px;"><input type = "text" id = "peak_area_rsd" class="peak_area_rsd" name ="peak_area_rsd"></td>
            <td style="padding: 8px;"><input type = "text" id = "asymmetry_rsd" class="asymmetry_rsd" name ="asymmetry_rsd"></td>
            <td style="padding: 8px;"><input type = "text" id = "resolution_rsd" class="resolution_rsd" name ="resolution_rsd"></td>
            <td style="padding: 8px;"><input type = "text" name ="other_rsd" id ="other_rsd"></td>
          </tr>
          <tr>
            <td align="center"style="padding: 8px;">Acceptance Criteria</td>
            <td style="padding: 8px;"><input type="text" name="rt_ac" class ="rt_ac" id="rt_ac" placeholder ="NMT 2.0%"></td>
            <td style="padding: 8px;"><input type="text" name="peak_area_ac" class="peak_area_ac" id="peak_area_ac" placeholder ="NMT 2.0%"></td>
            <td style="padding: 8px;"><input type="text" name="asymmetry_ac" class="asymmetry_ac" id="asymmetry_ac" placeholder ="NMT 2.0%"></td>
            <td style="padding: 8px;"><input type="text" name="resolution_ac" class="resolution_ac" id="resolution_ac" placeholder ="NLT 5.0%"></td>
          ...
          <tr>
            ...
            <td style="padding: 8px;"><input type = "text" name ="rt_comment" id="rt_comment"></td>
            <td style="padding: 8px;"><input type = "text" name ="peak_area_comment" class="peak_area_comment" id="peak_area_comment"></td>
            <td style="padding: 8px;"><input type = "text" name ="asymmetry_comment" class="asymmetry_comment" id="asymmetry_comment"></td>
            <td style="padding: 8px;"><input type = "text" name ="resolution_comment" class="resolution_comment" id="resolution_comment"></td>
          ...
          <div class="scroll">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">   
              <tr>
                ...
                <td align="center" style="padding: 8px;">Peak Area</td>
                <td align="center" style="padding: 8px;">Asymmetry</td>
                <td align="center" style="padding: 8px;">Theoretical Plates</td>
                <td align="center" style="padding: 8px;">Resolution</td>
              </tr>
           
              <tr>
                <td align="center"style="padding: 8px;">1.</td>
                <td style="padding: 8px;"><input type = "text" class = "sample_rt compute" name ="sample_rt_1" id ="sample_rt_1"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_peak_area compute" name ="sample_peak_area_1" id ="sample_peak_area_1"></td >
                <td style="padding: 8px;"><input type = "text" class = "sample_asymmetry compute" name ="sample_asymmetry_1" id="sample_asymmetry_1"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_theoretical compute" name ="sample_theoretical_1" id ="sample_theoretical_1"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_resolution compute" name ="sample_resolution_1" id ="sample_resolution_1"></td>
              </tr>
              <tr>
                <td align="center"style="padding: 8px;">2.</td>
                <td style="padding: 8px;"><input type = "text" class = "sample_rt compute" name ="sample_rt_2" id ="sample_rt_2"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_peak_area compute" name ="sample_peak_area_2" id ="sample_peak_area_2"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_asymmetry compute" name ="sample_asymmetry_2" id="sample_asymmetry_2"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_theoretical compute" name ="sample_theoretical_2" id ="sample_theoretical_2"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_resolution compute" name ="sample_resolution_2" id ="sample_resolution_2"></td>
              </tr>
              <tr>
                <td align="center"style="padding: 8px;">3.</td>
                <td style="padding: 8px;"><input type = "text" class = "sample_rt compute" name ="sample_rt_3" id ="sample_rt_3"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_peak_area compute" name ="sample_peak_area_3" id ="sample_peak_area_3"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_asymmetry compute" name ="sample_asymmetry_3" id="sample_asymmetry_3"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_theoretical compute" name ="sample_theoretical_3" id ="sample_theoretical_3"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_resolution compute" name ="sample_resolution_3" id ="sample_resolution_3"></td>
              </tr>
              <tr>
                <td align="center"style="padding: 8px;">4.</td>
                <td style="padding: 8px;"><input type = "text" class = "sample_rt compute" name ="sample_rt_4" id ="sample_rt_4"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_peak_area compute" name ="sample_peak_area_4" id ="sample_peak_area_4"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_asymmetry compute" name ="sample_asymmetry_4" id="sample_asymmetry_4"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_theoretical compute" name ="sample_theoretical_4" id ="sample_theoretical_4"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_resolution compute" name ="sample_resolution_4" id ="sample_resolution_4"></td>
              </tr>
              <tr>
                <td align="center"style="padding: 8px;">5.</td>
                <td style="padding: 8px;"><input type = "text" class = "sample_rt compute" name ="sample_rt_5" id="sample_rt_5" ></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_peak_area compute" name ="sample_peak_area_5" id ="sample_peak_area_5"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_asymmetry compute" name ="sample_asymmetry_5" id ="sample_asymmetry_5" ></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_theoretical compute" name ="sample_theoretical_5" id ="sample_theoretical_5"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_resolution compute" name ="sample_resolution_5"id ="sample_resolution_5"></td>
              </tr>
              <tr>
                <td align="center"style="padding: 8px;">6.</td>
                <td style="padding: 8px;"><input type = "text" class = "sample_rt  compute" name ="sample_rt_6" id="sample_rt_6" ></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_peak_area  compute" name ="sample_peak_area_6" id ="sample_peak_area_6" ></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_asymmetry  compute" name ="sample_asymmetry_6" id="sample_asymmetry_6" ></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_theoretical  compute" name ="sample_theoretical_6" id ="sample_theoretical_6"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_resolution  compute" name ="sample_resolution_6" id ="sample_resolution_6"></td>
              </tr>
              <tr>
                <td align="center"style="padding: 8px;">Average</td>
                <td style="padding: 8px;"><input type = "text" class = "sample_rt_avg" name ="sample_rt_avg" id ="sample_rt_avg"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_peak_area_avg" name ="sample_peak_area_avg" id ="sample_peak_area_avg" ></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_asymmetry_avg" name ="sample_asymmetry_avg" id="sample_asymmetry_avg"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_theoretical_avg" name ="sample_theoretical_avg" id ="sample_theoretical_avg"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_resolution_avg" name ="sample_resolution_avg" id ="sample_resolution_avg"></td>
              </tr>
              <tr>
                <td align="center"style="padding: 8px;">SD</td>
                <td style="padding: 8px;"><input type = "text" class = "sample_rt_sd" name ="sample_rt_sd" id ="sample_rt_sd"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_peak_area_sd" name ="sample_peak_area_sd" id="sample_peak_area_sd"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_asymmetry_sd" name ="sample_asymmetry_sd" id="sample_asymmetry_sd"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_theoretical_sd" name ="sample_theoretical_sd" id ="sample_theoretical_sd"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_resolution_sd" name ="sample_resolution_sd" id ="sample_resolution_sd"></td>
              </tr>
              <tr>
                <td align="center"style="padding: 8px;">RSD</td>
                <td style="padding: 8px;"><input type = "text" class = "sample_rt_rsd" name ="sample_rt_rsd" id ="sample_rt_rsd"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_peak_area_rsd" name ="sample_peak_area_rsd" id ="sample_peak_area_rsd"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_asymmetry_rsd" name ="sample_asymmetry_rsd" id ="sample_asymmetry_rsd"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_theoretical_rsd" name ="sample_theoretical_rsd" id ="sample_theoretical_rsd"></td>
                <td style="padding: 8px;"><input type = "text" class = "sample_resolution_rsd" name ="sample_resolution_rsd" id ="sample_resolution_rsd"></td>
              </tr>
              <tr>
                <td align="center"style="padding: 8px;">Acceptance Criteria</td>
                <td style="padding: 8px;"><input type="text" name="sample_rt_ac" id="sample_rt_ac" placeholder="NMT 2.0%"></td>
                <td style="padding: 8px;"><input type="text" name="sample_peak_area_ac" id="sample_peak_area_ac" placeholder="NMT 2.0%"></td>
                <td style="padding: 8px;"><input type="text" name="sample_asymmetry_ac" id="sample_asymmetry_ac" placeholder="NMT 2.0%"></td>
                <td style="padding: 8px;"><input type="text" name="sample_theoretical_plates_ac" id="sample_theoretical_plates_ac" placeholder="NLT 1000"></td>
                <td style="padding: 8px;"><input type="text" name="sample_resolution_ac" id="sample_resolution_ac" placeholder="NLT 2.0%"></td>
      ...
      <tr>
        <td colspan="8" style="padding:8px;border-bottom:solid 1px #c4c4ff;">
          <table border="0" width="100%" class="table_form" cellpadding="8px" align="center">            
            <tr>        
              <td colspan = "6" align = "center"style="padding: 12px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: solid 1px #bfbfbf;color:#0000fb;"><input type = "text" name ="sample_rrt_avg" id ="sample_value" placeholder="RT of SAMPLE"> / <input type = "text" name ="sample_rrt_avg" id ="std_value" placeholder ="RT of STD"></td>
              <td colspan = "6" align = "center"style="padding: 12px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: solid 1px #bfbfbf;color:#0000fb;"> =<input type = "text" name ="sample_rrt_avg" id ="sample_rrt_avg"></td>
            </tr>             
          </table>
          </td>
        </tr> 
      ...
      <tr>
        <td colspan = "3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $specs[0]['monograph_specifications']; ?></td>
        <td colspan = "3" align="center" style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type="text" name="method" size="40"> </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan = "6"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea cols ="90" rows="3" name="comment"></textarea> </td>
      </tr>           
           <tr>
      ...
      <tr>
        <td style ="padding: 8px;"colspan = "8" align ="center"> <input type ="submit" class="btn" name ="save_hplc_method" value ="Submit"></td>
      </tr>
    </table>
   </form> 
 </div>
