...
<table width="950px" class="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr>
     ...
     <tr> 
      ...
      <tr>  
        <td colspan = "3" style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $specs[0]['monograph_specifications'];?> </td>
      ...
      <tr>  
        <td colspan = "6"style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea cols ="90" rows="3" name="results_assay"></textarea> </td>  
         </tr>
      <tr>      
      ...
      <tr>
        <td colspan = "6"style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea cols ="90" rows="3" name="comment_assay"></textarea> </td>
      </tr>
       <tr>
     ...
     <tr>
        <td colspan = "6" align ="center"> <input type ="submit" class="btn" name ="save_identification" value ="Submit"></td>
      </tr>
    </table>
   </form> 
</div>
