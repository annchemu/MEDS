 ...
 <div id="header"> 
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <tr>
      ...
      <tr> 
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $specs[0]['monograph_specifications']; ?></td>
        <td colspan = "4" align="center" style="padding:4px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type="text" name="method" size="40"> </td>
      </tr>
      <tr> 
