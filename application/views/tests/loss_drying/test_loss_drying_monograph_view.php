...
<div id="forms">
 <?php echo validation_errors(); ?>
      <?php echo form_open('test_loss_drying/save_monograph',array('id'=>'assay_view'));?>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                Loss on Drying Specifications Details
              </td>
            </tr>
            <tr>
            ...
            <tr>
                <td  height="25px" style="padding:4px;background-color:#ffffff;border-top: solid 1px #bfbfbf;text-align: center;" colspan="8" ><input class="btn" type="submit" name="save_loss_dying_monograph" id="save_loss_dying_monograph" value="Submit"></td>
            </tr>
       </table>
      </form>
