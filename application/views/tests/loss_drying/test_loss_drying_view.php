...
<input type="hidden" name ="analyst" value ="<?php echo $user['logged_in']['fname']." ".$user['logged_in']['lname'];?>">
    ...
    <tr>
       ...
       <tr>
        <td align="left" colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color: #0000fb;" ><b>Weight of Standard taken (g)</b></td>
      </tr>
       <tr>
      ...
      <tr>
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Potency: <input type ="text" name="potency" id="potency"> </td>
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Lot No.: <input type ="text" name="lot_no" id="lot_no"> </td>
        <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">ID No.: <input type ="text" name="id_no" id="id_no"> </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan = "4"tyle="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="standard_weight_1" id ="standard_weight_1"> </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="sample_container_1" id ="standard_container_2"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="sample_container_2" id ="standard_container_3"> </td>
        <td colspan = "3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="sample_container_3" id ="standard_container_4"> </td>
      </tr>
      <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="container_1" id ="container_2" > </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="container_2" id ="container_3" > </td>
        <td colspan = "3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="container_3" id ="container_4"> </td>
      </tr>
      <tr>  
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="sample_weight_1" id ="standard_weight_2"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="sample_weight_2" id ="standard_weight_3"> </td>
        <td colspan = "3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="sample_weight_3" id ="standard_weight_4"> </td>
      </tr>
      <tr>  
      ...
      <tr>  
        <td colspan = "6"align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;"><b>Time</b></td>
      </tr>
      <tr>  
        <td align="center" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">1.</td>
      ...
      <tr>  
        <td align="center" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">2.</td>
      ...
      <tr>  
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;"><b>Difference in time</b></td>
      </tr>     
      <tr>  
        <td align="center" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">1.</td>          
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_11"> </td>
      ...
      <tr>
        <td colspan ="4" align ="center" style="padding: 12px;">
          ...
          <input type ="text" name="det_1_weight" id ="det_1_weight"size ="10" placeholder="WEIGHT AFTER DRYING">]&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp x 100 <br/><br/>
          <input type ="text" name="det_1_initial_weight" id ="det_1_initial_weight" size ="10" placeholder="INITIAL WEIGHT" ></td>        
        <td> =&nbsp &nbsp<input type ="text" name="determination_1" id ="loss_determination_1" size ="10"> % </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan ="4" align ="center" style="padding: 12px;">
          ...
          <input type ="text" name="det_2_weight" id ="det_2_weight"size ="10" placeholder="WEIGHT AFTER DRYING">]&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp x 100 <br/><br/>
          <input type ="text" name="det_2_initial_weight" id ="det_2_initial_weight" size ="10" placeholder="INITIAL WEIGHT" ></td>        
        <td>=&nbsp &nbsp <input type ="text" name="determination_2"id ="loss_determination_2" size ="10">% </td>
      </tr>
      <tr>  
      ...
      <tr>  
        <td colspan ="4" align ="center" style="padding: 12px;">
          ...
          <input type ="text" name="det_3_weight" id ="det_3_weight"size ="10" placeholder="WEIGHT AFTER DRYING">]&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp x 100 <br/><br/>
          <input type ="text" name="det_3_initial_weight" id ="det_3_initial_weight" size ="10" placeholder="INITIAL WEIGHT"></td>        
        <td>=&nbsp &nbsp <input type ="text" name="determination_3" id ="loss_determination_3" size ="10">% </td>
      </tr>
      <tr> 
        <td align="center"colspan ="6" style="padding: 8px;padding: 8px;background-color: #e8e8ff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> </td>
      </tr>
      <tr> 
        ...
        <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="average" id = "determination_avg_loss"></td>
       ...
       <tr> 
        ...
        <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="range_min" id ="range_min"> to <input type ="text" name="range_max" id ="range_max"></td>
        ...
        <td colspan = "2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="rsd" id ="determination_rsd_loss"></td>
      </tr>
      <tr>
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8px" align="center">
                    <tr>
                      ...
                      <td colspan="2" style="color:#0000ff;padding:8px;border-bottom:solid 1px #c4c4ff;"><?php echo $specs[0]['monograph_specifications']; ?></td>
      ...
      <tr>
        <td style ="padding: 8px;"colspan = "6" align ="center"> <input type ="submit" class="btn" name ="save_loss_dying_hplc" value ="Submit"></td>
      </tr>
    </table>
   </form> 
 </div>
