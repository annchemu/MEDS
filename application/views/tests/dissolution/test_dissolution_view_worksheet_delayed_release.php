...
<div id="form_wrapper">
<div id="forms">
<?php echo form_open('test_dissolution/worksheet_delayed_release_hplc', array('id'=>'test_dissolution_view'));?>
...
<table width="950" class ="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr> 
     ...
     <tr> 
      ...
      <tr>
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: solid 1px #bfbfbf;"><b>Dilution Factor</b></td>
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_determination['dilution_factor'];?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;" ><b>Mobile Phase Preparation</b></td>
      </tr>
       <tr>
        <td align="center"colspan = "6"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['mobile_phase'];?></textarea></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan ="3"tyle="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['column_pressure']; $query_e['column_pressure_select'];?></td>       
      </tr>
      <tr> 
        <td colspan ="3"align="right" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Column Oven Temperature:</td>
        <td colspan ="3"tyle="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['column_oven_temp']; $query_e['column_oven_temp_select'];?></td>       
      </tr>
      <tr>
        ...
        <td colspan ="3"tyle="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['flow_rate'];?></td>       
      </tr>
      <tr>
        ...
        <td colspan ="3"tyle="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['wavelength'];?></td>       
      </tr>  
      <tr>
        ...
        <td colspan ="6">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">       
            ...
            <tr>
              ...
              <td align="center"style="padding: 8px;"><?php echo $query_e['rt_1'];?></td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['peak_area_1'];?></td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['asymmetry_1'];?></td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['resolution_1'];?></td>
            </tr>
            <tr>
              <td align="center"style="padding: 8px;">2.</td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['rt_2'];?></td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['peak_area_2'];?></td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['asymmetry_2'];?></td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['resolution_2'];?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td align="center"style="padding: 8px;"><?php echo $query_e['rt_avg'];?></td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['peak_area_avg'];?></td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['asymmetry_avg'];?></td>
              <td align="center"style="padding: 8px;"><?php echo $query_e['resolution_avg'];?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td align="center"style="padding: 8px;">NMT 2.0%</td>
              <td align="center"style="padding: 8px;">NMT 2.0%</td>
              <td align="center"style="padding: 8px;">NMT 2.0%</td>
              <td align="center"style="padding: 8px;">NLT 5.0%</td>
          ...
          <div class="scroll">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">   
              ...
              <td align="center" style="padding: 8px;"><b>Sample 6</b></td>
                ...
                <tr>
                  <td align="center"style="padding: 8px;">1.</td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_1'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_1_s1'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_1_s2'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_1_s3'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_1_s4'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_1_s5'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_1_s6'];?></td>
                </tr>
                <tr>
                  <td align="center"style="padding: 8px;">2.</td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_2'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_2_s1'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_2_s2'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_2_s3'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_2_s4'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_2_s5'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_2_s6'];?></td>
                </tr>
                <tr>
                  <td align="center"style="padding: 8px;">3.</td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_3'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_3_s1'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_3_s2'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_3_s3'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_3_s4'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_3_s5'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_3_s6'];?></td>
                </tr>
                <tr>
                  <td align="center"style="padding: 8px;">4.</td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_4'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_4_s1'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_4_s2'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_4_s3'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_4_s4'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_4_s5'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_4_s6'];?></td>
                </tr>
                 <tr>
                  <td align="center"style="padding: 8px;">5.</td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_5'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_5_s1'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_5_s2'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_5_s3'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_5_s4'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_5_s5'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['sample_5_s6'];?></td>
                </tr>
                <tr>
                  <td align="center"style="padding: 8px;">Average</td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['avg'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['avg_s1'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['avg_s2'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['avg_s3'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['avg_s4'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['avg_s5'];?></td>
                  <td align="center"style="padding: 8px;"><?php echo $query_e['avg_s6'];?></td>
                </tr>
              </table>
         </div>
        </td>
      ...
      <tr>
        ...
        <td> =&nbsp &nbsp<?php echo $query_determination['determination_1'];?></td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td colspan="8" style="padding:8px;">
        <table border="0" width="90%" cellpadding="8px" align="center">
          <tr>
            <td style="border-bottom: dotted 1px #c4c4ff;padding:4px;text-align:right;">Supervisor: <?php echo $query_e['analyst'];?> </td>
