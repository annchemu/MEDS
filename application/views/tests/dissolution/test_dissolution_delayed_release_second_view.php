...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  $("#new_column").click(function(){
    // alert("cloned");
     $("apparatus_comment").append($("apparatus_comment tr:last").clone());
    // $("#apparatus_comment").append();
  });
...
<div id="form_wrapper">
<div id="forms">
<?php echo form_open('test_dissolution/worksheet_delayed_release_second_stage_hplc', array('id'=>'test_dissolution_view'));?>
    ...
    <tr>
     ...
     <tr>
      ...
      <tr>
        ...
        <td><input type="button" id="new_column"></td>
      </tr>
      <tr>
        ...
        <td colspan = "3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: solid 1px #bfbfbf;"> <input type ="text" name="apparatus_comment" id="apparatus_comment" value ="<?php echo $sql_dissolution['apparatus_comment'];?>"> </td>
      </tr>
      <tr>
        ...
        <td colspan = "3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="rotation_comment" id="rotation_comment" value ="<?php echo $sql_dissolution['rotation_comment'];?>"> </td>
      </tr>
      <tr>
        ...
        <td colspan = "3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_comment" id="time_comment" value ="<?php echo $sql_dissolution['time_comment'];?>"> </td>
      </tr>
      <tr>
        ...
        <td colspan = "3"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="temperature_comment" id="temperature_comment" value ="<?php echo $sql_dissolution['temperature_comment'];?>"> </td>
      </tr>     
       <tr>
      ...
      <tr>
        ...
        <td colspan = "4" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="container" id ="container"onchange="calculation_weight()" value ="<?php echo $sql_dissolution['container'];?>" > </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan ="4"align="left"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="column_pressure" value ="<?php echo $sql_dissolution['column_pressure'];?>">  <select name="column_pressure_select"><option value="Bar">Bar</option><option value="MPA">MPA</option><option value="PSI">PSI</option></select></td>       
      </tr>
      <tr> 
      ...
      <tr>
       ...
       <tr>
        <td colspan="6" style="padding: 8px; color:#0000fb;"><b>Data collected from Stage one: After <?php echo $sql_dissolution['minutes']?></b>  <input type="button" id="sample_data" value="+" class ="btn" size="20" /></td>
      </tr> 
      <tr>
        <td colspan ="6">
          <div class="scroll hide_data" id="sample_table">
           ...
           <tr>
                ...
                <tr>
                  <td align="center"style="padding: 8px;">Average</td>
                  <td style="padding: 8px;"><input type = "text" class = "standard_avg" name ="avg" id ="avg" disabled></td>
                  <td style="padding: 8px;"><input type = "text" class ="sample_1_avg" name ="avg_s1" id ="avg_s1" disabled></td>
                  <td style="padding: 8px;"><input type = "text" class ="sample_2_avg" name ="avg_s2" id ="avg_s2" disabled></td>
                  <td style="padding: 8px;"><input type = "text" class ="sample_3_avg" name ="avg_s3" id ="avg_s3" disabled></td>
                  <td style="padding: 8px;"><input type = "text" class ="sample_4_avg" name ="avg_s4" id ="avg_s4" disabled></td>
                  <td style="padding: 8px;"><input type = "text" class ="sample_5_avg" name ="avg_s5" id ="avg_s5" disabled></td>
                  <td style="padding: 8px;"><input type = "text" class ="sample_6_avg" name ="avg_s6" id ="avg_s6" disabled></td>
                </tr>
        </table>
      </div>
        </td>
      ...
      <tr>
        <td colspan ="4" align ="center" style="padding: 12px;">
          ...
          <input type ="text" name="det_1_awt" id ="det_2_awt" size ="10" placeholder="AWT" onchange="calculation_determinations()">
      ...
      <tr>  
        <td colspan ="4" align ="center" style="padding: 12px;">
          ...
          <input type ="text" name="det_1_awt" id ="det_3_awt" size ="10" placeholder="AWT" onchange="calculation_determinations()">
       ...
       <tr>
        <td colspan="8" style="padding:8px;border-bottom:solid 1px #c4c4ff;">
         ...
         <td colspan="8" style="padding:8px;">
          ...
          <tr>
            <td style="border-bottom: dotted 1px #c4c4ff;padding:4px;text-align:left;">Approved by: <select id="name" name="supervisor" >
            <option selected></option>
             <?php
