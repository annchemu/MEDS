...
<div id="forms">
    <?php echo validation_errors(); ?>
      <?php echo form_open('test_related_substances/save_monograph',array('id'=>'assay_view'));?>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;">
                Related Substances Specification Details
              </td>
            </tr>
            <tr>
            ...
            <tr>
                <td  height="25px" style="padding:4px;background-color:#ffffff;border-top: solid 1px #bfbfbf;text-align: center;" colspan="8" ><input class="btn" type="submit" name="save_related_substances" id="save_related_substances" value="Submit"></td>
            </tr>
       </table>
      </form>
