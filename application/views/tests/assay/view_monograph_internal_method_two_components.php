  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
   ...
   <?php 
    ...
    <div id="form_wrapper_lists">
      ...
      <?php echo form_open('assay/save_monograph_internal_method_two_components',array('id'=>'assay_view'));?>
       ...
       <table class="table_form" width="75%" border="0" cellpadding="4px" align="center">
        ...
        <input type="hidden" name="assignment_id" value="<?php echo $request[0]['a'];?>"></input>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>Assay Monograph Internal Method Two Components Details</h5></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;background-color: #ffffff;">
                <textarea rows="15" cols="180" name="assay_monograph"><?php echo $sql[0]['monograph']?></textarea>
              </td>
            </tr>
            <!-- <tr>
