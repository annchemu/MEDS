 ...
 <body>
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
    ...
    <div id="form_wrapper_lists">
      ...
      <?php echo form_open('assay/save_monograph_hplc_internal_method',array('id'=>'assay_monograph_hplc_internal_method'));?>
       ...
       <table class="table_form" width="75%" border="0" cellpadding="4px" align="center">
        ...
        <input type="hidden" name="assignment_id" value="<?php echo $request[0]['a'];?>"></input>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>HPLC INTERNAL METHOD DETAILS</h5></td>
            </tr>
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
               MONOGRAPH DETAILS
              </td>
            </tr>
            <tr>
              <td colspan="8" align="center" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;background-color: #ffffff;">
                <textarea rows="15" cols="180" name="monograph"></textarea>
              </td>
            </tr>
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;color:#0000ff;">
               SPECIFICATIONS
              </td>
            </tr>
            <tr>
              <td colspan="8" align="left" style="padding:8px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;background-color: #ffffff;">
                <input type="text" name="monograph_specifications" size="140">
              </td>
            </tr>
            <tr>
