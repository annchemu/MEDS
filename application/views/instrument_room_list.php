  ...
  <div id="form_wrapper_lists">
    <div id="account_lists" style="display: block;" name="menu">
      <table  class="subdivider" border="0" bgcolor="#ffffff" width="100%" cellpadding="8px" align="center">
		<tr>
		    <td  colspan="4"align="center" style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Instrument Room Temperature Records</h5></td>
		</tr>
		<tr>
      ...
      <td colspan="2">
        ...
        <a href="<?php echo base_url().'report/instrument';?>"><img src="<?php echo base_url().'images/icons/reports.png';?>" height="25px" width ="25px">Reports</b></a>
      </td>
      <td style ="text-align:center; color:blue;"><b>Standard Temperature Limit: 16 to 27C</b></td>
