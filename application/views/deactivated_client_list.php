    ...
    <div id="account_lists">
        <table class="subdivider" bgcolor="#ffffff" border="0" width="100%" cellpadding="4px">
            ...
            <tr>
                ...
                <td style="text-align:left;background-color:#ffffff;text-color:#00ff00;" width="140px"><a class ="current"href="<?php echo base_url().'deactivated_client_list/Get';?>">Decativated Accounts</a></td>
