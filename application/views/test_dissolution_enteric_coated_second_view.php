...
<div id="form_wrapper">
 <div id="forms">
<?php echo form_open('test_dissolution/worksheet_enteric_coated_hplc_second_stage', array('id'=>'test_dissolution_view'));?>
  <table width="75%"  class="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr>
      <td colspan="6" align="center" class="table_form" style="padding:8px;">
    ...
    <tr>
      ...
      <tr>
       ...
       <tr>
        <td colspan="2" align="center" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of standard + container (g)</td>
      ...
      <tr>
        <td colspan="2" align="center" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of container (g) </td>
      ...
      <tr>  
        <td colspan"6" align="center" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Dilution</td>
       </tr>  
      <tr>
      ...
      <tr>
        ...
        <td colspan ="2"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="column_pressure" value = "<?php echo $sql_dissolution['column_pressure']?>"> <select name="column_pressure_select"><option value="Bar">Bar</option><option value="MPA">MPA</option><option value="PSI">PSI</option></select> </td>       
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="column_oven_pressure" value = "<?php echo $sql_dissolution['column_oven_pressure']?>"> <select name="column_oven_pressure_select"><option value="F">F</option><option value="C">C</option></select></td>       
      </tr>
      <tr>
        ...
        <td colspan ="2"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="flow_rate" value = "<?php echo $sql_dissolution['flow_rate']?>"> nm</td>       
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="wavelength" value = "<?php echo $sql_dissolution['wavelength']?>"> mls/min</td>       
      </tr>  
      <tr>
      ...
      <tr>
        <td colspan="6" style="padding: 8px; color:#0000fb;"><b>Data collected from Stage one - Acid Stage:</b><input type="button" id="sample_data" value="+" class ="btn" size="20" /></td>
      </tr> 
      <tr>
        <td colspan ="6">
       ...
       <tr>
          <td colspan="6" style="padding:8px;">
            ...
            <table border="0" class="inner_table" cellpadding="8px" align="center">
               <tr>
                <td colspan="6" style="padding: 8px; color:#0000fb;"><b>Data collected from Stage two - Acid Stage:</b></td>                
              </tr>              
              <tr>
                <td><b></b></td>
                <td align="center" style="padding: 8px;"><b>Std 1</b></td>
      ...
      <tr>
        <td colspan="6" style="padding: 8px; color:#0000fb;"><b>Determination Data collected from Stage one - Acid Stage:</b><input type="button" id="determination" value="+" class ="btn" size="20" /></td>
      </tr> 
      <tr><td colspan="6">
       ...
       <tr>
        <td colspan ="6">
          <div class="scroll">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">  
              <tr>
                <td colspan="6" style="padding: 8px; color:#0000fb;"><b>Data collected from Stage one - Buffer Stage:</b></td>                
              </tr> 
              <tr>
                <td><b></b></td>
                <td align="center" style="padding: 8px;"><b>Std 1</b></td>
        ...
        <tr>
          <td colspan="6" style="padding:8px;">
            ...
            <table border="0" class="inner_table" cellpadding="8px" align="center">
              <tr>
                <td colspan="6" style="padding: 8px; color:#0000fb;"><b>Data collected from Stage two - Buffer Stage:</b></td>                
              </tr> 
              <tr>
                <td><b></b></td>
                <td align="center" style="padding: 8px;"><b>Std 1</b></td>
      ...
      <tr>
        <td colspan="6" style="padding: 8px; color:#0000fb;"><b>Determination Data collected from Stage one - Acid Stage:</b></td>                
      </tr> 
      <tr>
        <td align ="center" style="padding: 8px; color:#0000fb;">Determination one:</td>                
        <td colspan ="2" align ="center" style="padding: 12px;">
