  ...
  <div id="form_wrapper_lists">
    <div id="account_lists" style="display: block;" name="menu">
      <table  class="subdivider" border="0" bgcolor="#ffffff" width="100%" cellpadding="8px" align="center">
            <tr>
                <td  colspan="4"align="center" style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Sample Store Humidity Records</h5></td>
            </tr>
            <tr>
            ...
            <tr>
                    <td colspan="2">
                      ...
                      <a href="<?php echo base_url().'temperature_humidity_list/records_humidity/'.$id_humidity;?>" class="current sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/humidity.png';?>" height="20px" width ="20px">Humidity</a>
                      <a href="<?php echo base_url().'report/sample_store';?>"><img src="<?php echo base_url().'images/icons/reports.png';?>" height="25px" width ="25px">Reports</b></a>
                    </td>
                    <td style ="text-align:center; color:blue;"><b>Standard Humidity Limit: 65% (+/-5%)</b></td>
	...
	<tbody>
		<tr>
                    ...
                    ?>
                            ...
                            <a href=" <?php echo base_url().'temperature_humidity_log/Logs_Samples/'.$row->ht_id;?>">Log</a></td>
                    <?php $i++; ?>
		</tr>
                    <?php endforeach; ?>
	</tbody>
