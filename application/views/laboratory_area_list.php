  ...
  <div id="form_wrapper_lists">
    <div id="account_lists">
      <table  class="subdivider" border="0" bgcolor="#ffffff" width="100%" cellpadding="8px" align="center">
		<tr>
		    <td  colspan="4"align="center" style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Laboratory Area Temperature Records</h5></td>
		</tr>
		<tr>
      <td class="subdivider" align="center" colspan="4">
         ...
         <a href="<?php echo base_url().'temperature_humidity_list/records/'.$id_location_l;?>"class="current sub_menu sub_menu_link first_link">Laboratory Area</a>
		...
		<tr>
        <td colspan="2"style="text-align:left;background-color:#fdfdfd;padding:8px;"><a href="<?php echo base_url().'report/lab';?>"><img src="<?php echo base_url().'images/icons/reports.png';?>" height="25px" width ="25px">Reports</a></td>
        <td style ="text-align:right; color:blue;"><b>Standard Temperature Limit: 15 to 25C</b></td>
      	<td colspan="2"  style="text-align:right;background-color:#fdfdfd;padding:8px;"><a href="<?php echo base_url().'temperature_humidity';?>"><img src="<?php echo base_url().'images/icons/add_field.png';?>" height="10px" width ="10px">Add Humidity and Temperature</a></td>
		</tr>
	</table>
	...
	<tbody>
            ...
            <td>
               <div
                  <?php
                  if($row->min_temp_corrected<'15'){
                      echo "style='text-align:center;background-color:#8395db;'>";
                      echo "Temperature too low!";
                  }elseif($row->max_temp_corrected>'25'){
                      echo "style='text-align:center;background-color:#ffabab;'>";
                      echo "Temperature too high";
                  }else{
                      echo "style='text-align:center;background-color:#b3ffab;'>";
                      echo "Good working condition";
                  }
                  ?>
               </div>
            </td>
            <td><a href=" <?php echo base_url().'temperature_humidity_details/Get/'.$row->ht_id;?>">Edit</a>&nbsp;&nbsp;<a href=" <?php echo base_url().'temperature_humidity_log/Logs/'.$row->ht_id;?>">Log</a</td>
	    <?php $i++; ?>
	 </tr>
            <?php endforeach; ?>
	</tbody>
