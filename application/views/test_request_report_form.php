...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Test Request Reports</title>
		...
		<script>
			$(function() {
				$('#container').highcharts({
					...
					title : {
						text : 'MEDS Test Request Reports',
						x : -20, //center
      ...
      <tr>
       ...
       <td style="border-bottom: solid 1px #c4c4ff;padding:2px;text-align: left;background-color: #ffffff;" width="130px">
		...
		<div id="link" style="text-align:right;padding-top:10px;padding:4px;border-bottom: solid 1px #c4c4ff;">
		 <a href="<?php echo base_url().'test_request_list/GetA';?>"><img src="<?php echo base_url().'images/icons/back.png';?>" height="20px" width="20px"><b>Back to Test Request List</b></a>
		</div>
