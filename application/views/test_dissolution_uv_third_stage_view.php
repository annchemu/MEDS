          ...
          <div class="scroll hide_data" id="sample_table">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">   
            ...
            <tr>
              ...
              <td align="center" style="padding: 8px;">Std 1 (S1)</td>
              <td align="center" style="padding: 8px;">Sample 1 (S1)</td>
              <td align="center" style="padding: 8px;">Sample 2 (S1)</td>
              <td align="center" style="padding: 8px;">Sample 3 (S1)</td>
              <td align="center" style="padding: 8px;">Sample 4 (S1)</td>
              <td align="center" style="padding: 8px;">Sample 5 (S1)</td>
              <td align="center" style="padding: 8px;">Sample 6 (S1)</td>
              <td align="center" style="padding: 8px;">Std 1 (S2)</td>              
              <td align="center" style="padding: 8px;">Sample 1 (S2)</td>
              <td align="center" style="padding: 8px;">Sample 2 (S2)</td>
              <td align="center" style="padding: 8px;">Sample 3 (S2)</td>
              <td align="center" style="padding: 8px;">Sample 4 (S2)</td>
              <td align="center" style="padding: 8px;">Sample 5 (S2)</td>
              <td align="center" style="padding: 8px;">Sample 6 (S2)</td>
            </tr>
          ...
          <div class="scroll ">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">   
            ...
            <tr>
              ...
              <td style="padding: 8px;"><input type = "text" name ="difference_s7"></td>
              <td style="padding: 8px;"><input type = "text" name ="difference_s8"></td>
              <td style="padding: 8px;"><input type = "text" name ="difference_s9"></td>
              <td style="padding: 8px;"><input type = "text" name ="difference_s10"></td>
              <td style="padding: 8px;"><input type = "text" name ="difference_s11"></td>
              <td style="padding: 8px;"><input type = "text" name ="difference_s12"></td>
            </tr>
          </table>
         </div>
        </td>
