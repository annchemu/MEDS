 ...
 <body>
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
   ...
   <?php 
	...
	<table width="100%">
    <tr>
  		<td align="center" style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Complaint Records</h5></td>
    </tr>
    <tr>
  		<td align="right"><a href="<?php echo base_url().'complaints'?>" height="20px" width ="20px"><img src="<?php echo base_url().'images/icons/add_field.png';?>" height="10px" width="10px">Add Complaint</a></td>
    </tr>
    <tr>
      <td align="right">
        <a href="<?php echo base_url().'complaints_list/get_unassigned';?>"class="sub_menu sub_menu_link first_link">Unaddressed Complaints</a>
        <a href="<?php echo base_url().'complaints_list/records';?>"class="sub_menu sub_menu_link first_link">Addressed Complaints</a>
      </td>
    </tr>
	</table>
	<table id="list" class="list_view_header" width="100%" bgcolor="#ffffff" cellpadding="4px">
        ...
        <td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php echo $row->order_ref_no;?></td>
				...
				<td style="text-align: center;"><a href=" <?php echo base_url().'details/Get/'.$row->cid;?>">Details</a>
            <a href=" <?php echo base_url().'complaints_update/Get/'.$row->cid;?>">Edit</a>
