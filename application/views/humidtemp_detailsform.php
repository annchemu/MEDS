...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
  ...
  <div id="freezer" name="menu" style="display:block;">
     ...
     <input type="hidden" name"user" value ="<?php echo($user['logged_in']['fname']." ".$user['logged_in']['lname']);?>">
		...
		<tr>
			<td colspan = "6" align ="center" style="text-align:center;background-color:#ffffff;padding-right:40px;border-bottom: solid 10px #f0f0ff;color: #0000fb;background-color: #e8e8ff;"> 
				<h4><b>HUMIDITY AND TOLERANCE</b></h4>
			</td>	
		</tr>
		<tr>
      ...
      <a href="javascript:slide('refrigerator_form');" class="sub_menu sub_menu_link first_link"><b>Refrigerator</b></a>
		...
		<tr>
			...
			<td colspan="3"style="background-color:#ffffff;border-right: dotted 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">
		...
		<tr>
			<td style="background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Minimun Temperature	</td>			
    ...
    <tr>
      <td style="background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> Reason for Editing</td>
      ...
      <td colspan="6" style="text-align:center;background-color:#ffffff;border-right: dotted 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;">
        <input type = "submit" name ="update_humidtemp" id ="save_humidtempref" value ="Submit">
      </td>  
    </tr>
	</table>
	</form>
       ...
       <div id="sample_store" name="menu" style="display:none;"><?php include_once "application/views/sample_store_updateform.php";?></div>
       <div id="laboratory_area" name="menu" style="display:none;"><?php include_once "application/views/laboratory_area_updateform.php";?></div>  
       <div id="instrument_room" name="menu" style="display:none;"><?php include_once "application/views/instrument_room_updateform.php";?></div>
       <div id="refrigerator_form" name="menu" style="display:none;"><?php include_once "application/views/refrigerator_detailsform.php";?></div>
</body>		
</html>