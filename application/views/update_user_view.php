 ...
 <body>
  ...
  <div id="form_wrapper_lists">
    <div id="analysis_request">
        ...
        <?php echo form_open('update_user_record/Submit');?>
        <table class="table_form" bgcolor="#f0f0ff" width="950px" height="250px" border="0" cellpadding="4px" align="center">
            <input type="hidden" name="my_id" value="<?php echo $query['id']; ?>"/>
            <tr>
                <td colspan="6" style="text-align:right;background-color:#ffffff;text-color:#00ff00;"><a href="<?php echo base_url().'user_accounts/Get';?>"><img src="<?php echo base_url().'images/icons/back.png'?>" height="20px" width="20px">Back</a></td>
            </tr>
            <tr>
                <td colspan="6" align="center" style="padding:8px;border-bottom: solid 1px #bfbfbf;color: #0000ff;background-color:#e8e8ff ;"><h5>UPDATING USER ACCOUNT FORM</h5></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="background-color:#8aff8a;"><?php echo $query['role'];?></td>
            ...
            <tr>
                <td colspan="6" height="20px" style="background-color:#ffffff;border-bottom: dotted 1px #bfbfbf; border-right: dotted 1px #bfbfbf;"><b>Update Role & Status</b></td>
            </tr>
            <tr>
                <td style="background-color:#ffffff;border-bottom: dotted 1px #bfbfbf; border-right: solid 1px #bfbfbf;"><b>User Role</b></td>
                <td style="background-color:#ffffff;border-right: solid 1px #bfbfbf;">
                 <select type="text" name="role">
                  <option value="<?php echo $query['user_type'];?>" slected="selected"><?php echo $query['role'];?></option>
                  <option value="1">MEDS System Administrator</option>
                ...
                <td style="background-color:#ffffff;border-bottom: dotted 1px #bfbfbf; border-right: solid 1px #bfbfbf;"><b>Change Status</b></td>
                <td colspan="3" style="background-color:#ffffff;border-right: solid 1px #bfbfbf;"><input type="radio" name="status" checked="" value="2">Inactive<input type="radio" name="status" checked="" value="1">Activate<input type="radio" name="status" value="0"/>Deactivate</td>
        </tr>
            <tr>
