...
<?php
  ...
  <div id="form_wrapper_lists">
    ...
    <tr>
      <td class="subdivider" align="center" colspan="4">
         ...
         <a href="<?php echo base_url().'temperature_humidity_list/records/'.$id_location_r;?>"class="current sub_menu sub_menu_link first_link">Refrigerator</a>
      </td>
    </tr>
    <tr>
      <td colspan="2"style="text-align:left;background-color:#fdfdfd;padding:8px;"><a href="<?php echo base_url().'report/refrigerator';?>"><img src="<?php echo base_url().'images/icons/reports.png';?>" height="25px" width ="25px">Reports</a>
      </td>
      <td align ="right" style ="color:blue;" ><b>Standard Limit: 2 to 8C</b>
      </td>
  ...
  <tbody>
      ...
      ?>
        ...
        <td><a href=" <?php echo base_url().'temperature_humidity_details/Get/'.$row->ht_id;?>">Edit</a>&nbsp;&nbsp;<a href=" <?php echo base_url().'temperature_humidity_log/Logs/'.$row->ht_id;?>">Log</a>
        </td>
      <?php $i++; ?>
    </tr>
      <?php endforeach; ?>
