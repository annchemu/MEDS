...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <script>
   ...
   <script>
       function sd_resolution(){
        var total = (document.getElementById('resolution_1').value - document.getElementById('resolution_2').value
                    document.getElementById('resolution_3').value - document.getElementById('resolution_4').value
                    document.getElementById('resolution_5').value - document.getElementById('resolution_6').value)/6; 
       }        
   </script>
  </head>
  <body>
  ...
  <table width="75%"  class="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr>
      ...
      <tr>
       ...
       <tr>
        <td colspan = "6"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><textarea cols="50" rows="4" name = "sample_preparation"></textarea></td>
      </tr>
       <tr>
      ...
      <tr>
        <td style ="padding: 8px;"colspan = "8" align ="center"> <input type ="submit" name ="save_enteric_coated_hplc" value ="Save Dissolution Data"></td>
      </tr>
    </table>
   </form> 
 </div>
