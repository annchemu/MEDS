  ...
  <div id="form_wrapper_lists">
    <div id="account_lists">
      <table  class="subdivider" border="0" bgcolor="#ffffff"  width="100%" cellpadding="8px" align="center">
          <tr>
              <td colspan="2" align="center" style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Withdrawn/Damaged Equipment Records</h5></td>
          </tr>
          <tr>
              ...
              <td align ="left">
                  ...
                  <a href="<?php echo base_url().'equipment_maintenance_records/getDamaged';?>" class="current sub_menu sub_menu_link first_link">Withdrawn/Damaged Equipment</a>
              ...
              <td align="right"
               ...
               ?>>
             <a data-target="#withdrawn_equipment_form" class="btn" role="button" data-toggle="modal"><img src="<?php echo base_url().'images/icons/add_field.png'?>" height="10px" width="10px">Add Equipment</a>            
             ...
             <a href="<?php echo base_url().'equipment_maintenance_records/print_damaged_records';?>"><img src="<?php echo base_url().'images/icons/pdf.png';?>" height="20px" width ="20px">PDF</a>
        ...
        <table id="list" class="list_view_header" width="100%"  border='0'cellpadding="4px">
            ...
            <tbody>
                ...
                ?>
                    ...
                    <td width="340px" style="text-align: left;border-bottom: solid 1px #c0c0c0;"><?php echo $row->description;?></td>
    ...
    <div id="withdrawn_equipment_form" class="modal fade" role="dialog" aria-labelledby="equipment" aria-hidden="true"><?php include_once "application/views/equipment_maintenance_form.php";?></div>   
