    ...
    <div id="account_lists" style="display: block" name="menu">
        ...
        <table id="list" class="list_view_header" width="100%" cellpadding="4px">
            <thead bgcolor="#efefef">
             <!--  <tr>
                    <td colspan="2"><a href=" <?php echo base_url().'temperature_humidity_details/Get/'.$ht_id;?>" class="sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/temperature.png';?>" height="20px" width ="20px"><b>Temperature</b></a>
                    <a href=" <?php echo base_url().'temperature_humidity_log/Logs_Samples/'.$ht_id;?>" class="sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/humidity.png';?>" height="20px" width ="20px"><b>Humidity</b></a>
                    </td>
            </tr>-->
                <tr>
                    ...
                    <th style="border-right: dotted 1px #ddddff;" align="center">Old Max Equipment Used</th>
