  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
   ...
   <?php 
	...
	<table class="subdivider" width="100%">
	   <tr>
		    <td colspan="4" align="center" style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Addressed Complaint Records</h5></td>
	   </tr>
	   <tr>
      		<td align="left">
      		    <a href="<?php echo base_url().'complaints_list/get_unassigned';?>"class="sub_menu sub_menu_link  "><img src="<?php echo base_url().'images/icons/circle_orange.png';?>" height="20px" width ="20px">Unaddressed Complaints</a>
      		    <a href="<?php echo base_url().'complaints_list/records';?>"class="sub_menu sub_menu_link current"><img src="<?php echo base_url().'images/icons/tick.png';?>" height="20px" width ="20px">Addressed Complaints</a>
      		</td>
      		<td align="right">
	...
	<table id="list" class="list_view_header" width="100%" bgcolor="#ffffff" cellpadding="4px">
        ...
        <td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php echo $row->order_ref_no;?></td>
				...
				<td style="text-align: center;"><a href=" <?php echo base_url().'complaints_log/Logs/'.$row->cid;?>">Logs</a></td>
        <td style="text-align: center;"><a href=" <?php echo base_url().'details/GetA/'.$row->cid;?>">Details</a></td>
