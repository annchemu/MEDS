 ...
 <body>
  ...
  <table  border="0" cellpadding="2px" align="center" width="100%">
   ...
   <?php 
    ...
    <tr>
	    <td colspan="4" align="center" style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Unaddressed Complaint Records</h5></td>
    </tr>
    <tr>
    	<td align="left">
    	    <a href="<?php echo base_url().'complaints_list/get_unassigned';?>"class="sub_menu sub_menu_link first_link current"><img src="<?php echo base_url().'images/icons/circle_orange.png';?>" height="20px" width ="20px">Unaddressed Complaints</a>
    	    <a href="<?php echo base_url().'complaints_list/records';?>"class=" sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/tick.png';?>" height="20px" width ="20px">Addressed Complaints</a>
    	</td>
      <td align="right">
            <a href="<?php echo base_url().'complaints_report'?>" height="20px" width ="20px"><img src="<?php echo base_url().'images/icons/reports.png';?>" height="25px" width="25px">Reports</a>
            <a href="<?php echo base_url().'complaints'?>" height="20px" width ="20px"><img src="<?php echo base_url().'images/icons/add_field.png';?>" height="10px" width="10px">Add Complaint</a>
          </td>
      </tr>
	</table>
	<table id="list" class="list_view_header" width="100%" bgcolor="#ffffff" cellpadding="4px">
		<thead bgcolor="#efefef">
			<tr>
				...
				<th style="text-align:center;border-right: dotted 1px #ddddff;">REF No.</th>
				<th style="text-align:center;border-right: dotted 1px #ddddff;">Customer Name</th>
        <th style="text-align:center;border-right: dotted 1px #ddddff;">Order Ref No.</th>
				<th style="text-align:center;border-right: dotted 1px #ddddff;">Nature of Complaint</th>
				<th style="text-align:center;border-right: dotted 1px #ddddff;">Complaint Details</th>
				<th style="text-align:center;border-right: dotted 1px #ddddff;">Address</th>
		...
		<tbody>
			...
			?>
				...
				<td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php echo $row->ref_no;?></td>
				<td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php echo $row->client_name;?></td>
        <td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php echo $row->order_ref_no;?></td>
				<td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php echo $row->complaint_nature;?></td>
				<td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php echo $row->complaint_details;?></td>
				<td style="text-align: center;"><a href=" <?php echo base_url().'details/Get/'.$row->cid;?>">Address</a></td>  
        <td style="text-align: center;"><a href=" <?php echo base_url().'complaints_update/Get/'.$row->cid;?>">Edit</a></td>
				<?php $i++; ?>
