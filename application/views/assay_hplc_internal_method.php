          ...
          <td colspan="8" align="center" style="padding:8px;">
            <table class="table_form" border="0" align="center" cellpadding="8px" width="100%" >
              ...
              <tr>    
                  ...
                  <td colspan="4" height="25px" style="padding:4px;border-bottom:solid 1px #bfbfbf;border-top:solid 1px #bfbfbf;text-align:left;background-color:#ffffff;border-right:solid 1px #bfbfbf;">Title: <?php echo $query['active_ingredients']." "." ".$query['test_specification'];?><input type="hidden" value="<?php echo $query['test_specification'];?>"></td>
            ...
            <td colspan="8" style="padding:8px;border-bottom:dotted 1px #c4c4ff;">
              <table class="inner_table" width="80%" border="0" align="center" cellpadding="8px"> 
                ...
                <tr>
                    ...
                    Weight of container(g)</td>
                    <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    <input type="text" name="weight_container_one" id="container_one" onChange="calculate_sample_difference()"></td>
                    <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                    <input type="text" name="weight_container_two" id="container_two" onChange="calculate_sample_difference()"></td>
              ...
              <td colspan="8" align="center">
                <table class="inner_table" width="90%" align="center" cellpadding="8px">
                    ...
                    <tr>
                        ...
                        Weight of Sample + container(g)</td>
                        <td  height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_container_one_one" id="weight_sample_container_one_one" size="10"></td>
                        <td  height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_container_two_one" id="weight_sample_container_two_one" size="10"></td>
                        <td  height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_container_three_one" id="weight_sample_container_three_one" size="10"></td>
                        <td  height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_container_four_one" id="weight_sample_container_four_one" size="10"></td>
                        <td  height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_container_five_one" id="weight_sample_container_five_one" size="10"></td>
                    ...
                    <tr>
                        ...
                        Weight of container(g)</td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_container_one_two" id="weight_container_one_two" onChange="calculate_difference()" size="10"></td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_container_two_two" id="weight_container_two_two" onChange="calculate_difference()" size="10"></td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_container_three_two" id="weight_container_three_two" onChange="calculate_difference()" size="10"></td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_container_four_two" id="weight_container_four_two" onChange="calculate_difference()" size="10"></td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_container_five_two" id="weight_container_five_two" onChange="calculate_difference()" size="10"></td>
                    ...
                    <tr>
                        ...
                        Weight of Sample(g)</td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_one_three" id="weight_sample_one_three" onChange="calculate_difference()" size="10"></td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_two_three" id="weight_sample_two_three" onChange="calculate_difference()" size="10"></td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_three_three" id="weight_sample_three_three" onChange="calculate_difference()" size="10"></td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_four_three" id="weight_sample_four_three" onChange="calculate_difference()" size="10"></td>
                        <td height="25px" align="left" style="color:#000;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">
                        <input type="text" name="weight_sample_five_three" id="weight_sample_five_three" onChange="calculate_difference()" size="10"></td>
              ...
              <td colspan="8" style="padding:8px;">
                <table width="90%" class="inner_table" border="0" cellpadding="8px" align="center">
                  <tr>
                    ...
                    <td style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;"><input type="text" name="column_pressure"/> <select name="column_pressure_type">
                  ...
                  <tr>
                    ...
                    <td style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;"><input type="text" name="column_oven_temperature"/> <select name="column_oven_temperature_type">
                      <option></option><option value="Celsius">Celsius</option><option value="Fahrenheit">Fahrenheit</option><select></td>
                  </tr>
                  <tr>
                    <td style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">Mobile Phase Flow Rate (nm)</td>
                  ...
                  <tr>
                    <td style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;">Detection Wavelength (mls/min)</td>
                ...
                <td colspan="8" style="padding:8px;">
                  ...
                  <table border="0" class="inner_table" cellpadding="8px" align="center">
                    ...
                    <tr>
                      ...
                      <td><input type="text" id="internal_std_a_one" name="internal_std_one_one" size="10"></input></td>
                      <td><input type="text" id="ratio_std_a_one" name="ratio_std_one_one" size="10"></input></td>

                      <td><input type="text" id="sample_one_one" name="sample_one_one" size="10"></input></td>
                      <td><input type="text" id="internal_std_b_one" name="internal_std_one_two" size="10"></input></td>
                      <td><input type="text" id="ratio_std_b_one" name="ratio_std_two_one" size="10"></input></td>

                      <td><input type="text" id="sample_one_two" name="sample_one_two" size="10"></input></td>
                      <td><input type="text" id="internal_std_c_one" name="internal_std_one_three" size="10"></input></td>
                      <td><input type="text" id="ratio_std_c_one" name="ratio_std_one_three" size="10"></input></td>

                      <td><input type="text" id="sample_one_three" name="sample_one_three" size="10"></input></td>
                      <td><input type="text" id="internal_std_d_one" name="internal_std_one_four" size="10"></input></td>
                      <td><input type="text" id="ratio_std_d_one" name="ratio_std_one_four" size="10"></input></td>

                      <td><input type="text" id="sample_one_four" name="sample_one_four" size="10"></input></td>
                      <td><input type="text" id="internal_std_e_one" name="internal_std_one_five" size="10"></input></td>
                      <td><input type="text" id="ratio_std_e_one" name="ratio_std_one_five" size="10"></input></td>

                      <td><input type="text" id="sample_one_five" name="sample_one_five" size="10"></input></td>
                      <td><input type="text" id="internal_std_f_one" name="internal_std_one_six" size="10"></input></td>
                      <td><input type="text" id="ratio_std_f_one" name="ratio_std_one_six" size="10"></input></td>

                      <td><input type="text" id="sample_one_six" name="sample_one_six" size="10"></input></td>
                      <td><input type="text" id="internal_std_g_one" name="internal_std_one_seven" size="10"></input></td>
                      <td><input type="text" id="ratio_std_g_one" name="ratio_std_one_seven" size="10"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">2.</td>
                      <td><input type="text" id="std_two" name="std_two" onChange="calc_avg_std()" size="10"></input></td>
                      <td><input type="text" id="internal_std_a_two" name="internal_std_two_one" onChange="calc_internal_std()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_a_two" name="ratio_std_two_one" onChange="calc_ratio_std()" size="10"></input></td>

                      <td><input type="text" id="sample_two_one" name="sample_two_one" onChange="calc_avg_sample_one()" size="10"></input></td>
                      <td><input type="text" id="internal_std_b_two" name="internal_std_two_two" onChange="calc_internal_std_two()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_b_two" name="ratio_std_two_two" onChange="calc_ratio_std_two()" size="10"></input></td>

                      <td><input type="text" id="sample_two_two" name="sample_two_two" onChange="calc_avg_sample_two()" size="10"></input></td>
                      <td><input type="text" id="internal_std_c_two" name="internal_std_two_three" onChange="calc_internal_std_three()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_c_two" name="ratio_std_three_two" onChange="calc_ratio_std_three()" size="10"></input></td>

                      <td><input type="text" id="sample_two_three" name="sample_two_three" onChange="calc_avg_sample_three()" size="10"></input></td>
                      <td><input type="text" id="internal_std_d_two" name="internal_std_two_four" onChange="calc_internal_std_four()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_d_two" name="ratio_std_two_four" onChange="calc_ratio_std_four()" size="10"></input></td>


                      <td><input type="text" id="sample_two_four" name="sample_two_four" onChange="calc_avg_sample_four()" size="10"></input></td>
                      <td><input type="text" id="internal_std_e_two" name="internal_std_two_five" onChange="calc_internal_std_five()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_e_two" name="ratio_std_two_five" onChange="calc_ratio_std_five()" size="10"></input></td>

                      <td><input type="text" id="sample_two_five" name="sample_two_five" onChange="calc_avg_sample_five()" size="10"></input></td>
                      <td><input type="text" id="internal_std_f_two" name="internal_std_two_six" onChange="calc_internal_std_six()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_f_two" name="ratio_std_two_six" onChange="calc_ratio_std_six()" size="10"></input></td>

                      <td><input type="text" id="sample_two_six" name="sample_two_six" onChange="calc_avg_sample_six)" size="10"></input></td>
                      <td><input type="text" id="internal_std_g_two" name="internal_std_two_seven" onChange="calc_internal_std_seven()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_g_two" name="ratio_std_two_seven" onChange="calc_ratio_std_seven()" size="10"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">3.</td>
                      <td><input type="text" id="std_three" name="std_three" onChange="calc_avg_std()" size="10"></input></td>
                      <td><input type="text" id="internal_std_a_three" name="internal_std_three_one" onChange="calc_internal_std()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_a_three" name="ratio_std_three_one" onChange="calc_ratio_std()" size="10"></input></td>

                      <td><input type="text" id="sample_three_one" name="sample_three_one" onChange="calc_avg_sample_one()" size="10"></input></td>
                      <td><input type="text" id="internal_std_b_three" name="internal_std_three_two" onChange="calc_internal_std_two()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_b_three" name="ratio_std_two_three" onChange="calc_ratio_std_two()" size="10"></input></td>

                      <td><input type="text" id="sample_three_two" name="sample_three_two" onChange="calc_avg_sample_two()" size="10"></input></td>
                      <td><input type="text" id="internal_std_c_three" name="internal_std_three_three" onChange="calc_internal_std_three()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_c_three" name="ratio_std_three_three" onChange="calc_ratio_std_three()" size="10"></input></td>

                      <td><input type="text" id="sample_three_three" name="sample_three_three" onChange="calc_avg_sample_three()" size="10"></input></td>
                      <td><input type="text" id="internal_std_d_three" name="internal_std_three_four" onChange="calc_internal_std_four()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_d_three" name="ratio_std_three_four" onChange="calc_ratio_std_four()" size="10"></input></td>

                      <td><input type="text" id="sample_three_four" name="sample_three_four" onChange="calc_avg_sample_four()" size="10"></input></td>
                      <td><input type="text" id="internal_std_e_three" name="internal_std_three_five" onChange="calc_internal_std_five()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_e_three" name="ratio_std_three_five" onChange="calc_ratio_std_five()" size="10"></input></td>

                      <td><input type="text" id="sample_three_five" name="sample_three_five" onChange="calc_avg_sample_five()" size="10"></input></td>
                      <td><input type="text" id="internal_std_f_three" name="internal_std_three_six" onChange="calc_internal_std_six()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_f_three" name="ratio_std_three_six" onChange="calc_ratio_std_six()" size="10"></input></td>

                      <td><input type="text" id="sample_three_six" name="sample_three_six" onChange="calc_avg_sample_six()" size="10"></input></td>
                      <td><input type="text" id="internal_std_g_three" name="internal_std_three_seven" onChange="calc_internal_std_seven()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_g_three" name="ratio_std_three_seven" onChange="calc_ratio_std_seven()" size="10"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">4.</td>
                      <td><input type="text" id="std_four" name="std_four" onChange="calc_avg_std()" size="10"></input></td>
                      <td><input type="text" id="internal_std_a_four" name="internal_std_four_one" onChange="calc_internal_std()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_a_four" name="ratio_std_four_one" onChange="calc_ratio_std()" size="10"></input></td>

                      <td><input type="text" id="sample_four_one" name="sample_four_one" onChange=" calc_avg_sample_one()" size="10"></input></td>
                      <td><input type="text" id="internal_std_b_four" name="internal_std_four_two" onChange="calc_internal_std_two()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_b_four" name="ratio_std_four_two" onChange="calc_ratio_std_two()" size="10"></input></td>

                      <td><input type="text" id="sample_four_two" name="sample_four_two" onChange="calc_avg_sample_two()" size="10"></input></td>
                      <td><input type="text" id="internal_std_c_four" name="internal_std_three_four" onChange="calc_internal_std_three()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_c_four" name="ratio_std_four_three" onChange="calc_ratio_std_three()" size="10"></input></td>

                      <td><input type="text" id="sample_four_three" name="sample_four_three" onChange="calc_avg_sample_three()" size="10"></input></td>
                      <td><input type="text" id="internal_std_d_four" name="internal_std_four_four" onChange="calc_internal_std_four()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_d_four" name="ratio_std_four_four" onChange="calc_ratio_std_four()" size="10"></input></td>

                      <td><input type="text" id="sample_four_four" name="sample_four_four" onChange="calc_avg_sample_four()" size="10"></input></td>
                      <td><input type="text" id="internal_std_e_four" name="internal_std_four_five" onChange="calc_internal_std_five()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_e_four" name="ratio_std_four_five" onChange="calc_ratio_std_five()" size="10"></input></td>

                      <td><input type="text" id="sample_four_five" name="sample_four_five" onChange="calc_avg_sample_five()" size="10"></input></td>
                      <td><input type="text" id="internal_std_f_four" name="internal_std_four_six" onChange="calc_internal_std_six()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_f_four" name="ratio_std_four_six" onChange="calc_ratio_std_six()" size="10"></input></td>

                      <td><input type="text" id="sample_four_six" name="sample_four_six" onChange="calc_avg_sample_six()" size="10"></input></td>
                      <td><input type="text" id="internal_std_g_four" name="internal_std_four_seven" onChange="calc_internal_std_seven()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_g_four" name="ratio_std_four_seven" onChange="calc_ratio_std_seven()" size="10"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">5.</td>
                      <td><input type="text" id="std_five" name="std_five" onChange="calc_avg_std()" size="10"></input></td>
                      <td><input type="text" id="internal_std_a_five" name="internal_std_five_one" onChange="calc_internal_std()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_a_five" name="ratio_std_five_one" onChange="calc_ratio_std()" size="10"></input></td>

                      <td><input type="text" id="sample_five_one" name="sample_five_one" onChange="calc_avg_sample_one()" size="10"></input></td>
                      <td><input type="text" id="internal_std_b_five" name="internal_std_five_two" onChange="calc_internal_std_two()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_b_five" name="ratio_std_five_two" onChange="calc_ratio_std_two()" size="10"></input></td>

                      <td><input type="text" id="sample_five_two" name="sample_five_two" onChange="calc_avg_sample_two()" size="10"></input></td>
                      <td><input type="text" id="internal_std_c_five" name="internal_std_five_three" onChange="calc_internal_std_three()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_c_five" name="ratio_std_five_three" onChange="calc_ratio_std_three()" size="10"></input></td>

                      <td><input type="text" id="sample_five_three" name="sample_five_three" onChange="calc_avg_sample_three()" size="10"></input></td>
                      <td><input type="text" id="internal_std_d_five" name="internal_std_five_four" onChange="calc_internal_std_four()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_d_five" name="ratio_std_five_four" onChange="calc_ratio_std_four()" size="10"></input></td>


                      <td><input type="text" id="sample_five_four" name="sample_five_four" onChange="calc_avg_sample_four()" size="10"></input></td>
                      <td><input type="text" id="internal_std_e_five" name="internal_std_five_five" onChange="calc_internal_std_five()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_e_five" name="ratio_std_five_five" onChange="calc_ratio_std_five()" size="10"></input></td>

                      <td><input type="text" id="sample_five_five" name="sample_five_five" onChange="calc_avg_sample_five()" size="10"></input></td>
                      <td><input type="text" id="internal_std_f_five" name="internal_std_five_six" onChange="calc_internal_std_six()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_f_five" name="ratio_std_five_six" onChange="calc_ratio_std_six()" size="10"></input></td>

                      <td><input type="text" id="sample_five_six" name="sample_five_six" onChange="calc_avg_sample_six()" size="10"></input></td>
                      <td><input type="text" id="internal_std_g_five" name="internal_std_five_seven" onChange="calc_internal_std_seven()" size="10"></input></td>
                      <td><input type="text" id="ratio_std_g_five" name="ratio_std_five_seven" onChange="calc_ratio_std_seven()" size="10"></input></td>

                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">Average</td>

                      <td><input type="text" id="std_average" name="std_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="internal_std_a_average" name="internal_std_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="ratio_std_a_average" name="ratio_std_one_average" onChange="" size="10"></input></td>

                      <td><input type="text" id="sample_one_average" name="sample_one_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="internal_std_b_average" name="internal_std_two_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="ratio_std_b_average" name="ratio_std_two_average" onChange="" size="10"></input></td>

                      <td><input type="text" id="sample_two_average" name="sample_two_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="internal_std_c_average" name="internal_std_three_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="ratio_std_c_average" name="ratio_std_three_average" onChange="" size="10"></input></td>

                      <td><input type="text" id="sample_three_average" name="sample_three_average" onChange="" size="10"></td>
                      <td><input type="text" id="internal_std_d_average" name="internal_std_four_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="ratio_std_d_average" name="ratio_std_four_average" onChange="" size="10"></input></td>


                      <td><input type="text" id="sample_four_average" name="sample_four_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="internal_std_e_average" name="internal_std_five_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="ratio_std_e_average" name="ratio_std_five_average" onChange="" size="10"></input></td>

                      <td><input type="text" id="sample_five_average" name="sample_five_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="internal_std_f_average" name="internal_std_six_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="ratio_std_f_average" name="ratio_std_six_average" onChange="" size="10"></input></td>

                      <td><input type="text" id="sample_six_average" name="sample_six_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="internal_std_g_average" name="internal_std_seven_average" onChange="" size="10"></input></td>
                      <td><input type="text" id="ratio_std_g_average" name="ratio_std_seven_average" onChange="" size="10"></input></td>
                ...
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8" align="center">
                    ...
                    <tr>
                      ...
                      <td style="padding:8px;">=<input type="text" id="d_four_p_lc" name="d_four_p_lc" onChange="calc_determination()" placeholder="(%LC)" size="10" disabled/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td style="padding:8px;">=<input type="text" id="d_five_p_lc" name="d_five_p_lc" onChange="calc_determination()" placeholder="(%LC)" size="10" disabled/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td style="padding:8px;">=<input type="text" id="d_six_p_lc" name="d_six_p_lc" onChange="calc_determination()" placeholder="(%LC)" size="10" disabled/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="3" style="padding:8px;">Average % &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="determination_average" name="determination_average" onChange="calculator()" disabled></input></td>
                    </tr>
                    <tr>
                      <td colspan="6" style="padding:8px;">Equivalent To &nbsp;<input type="text" name="determination_equivalent_to"></input></td>
                    </tr>
                    <tr>
                      <td colspan="6" style="padding:8px;">Range %&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="det_min" name="det_min" size="4" placeholder="min%" onChange="calc_determination()" disabled></input> - <input type="text" id="det_max" name="det_max" size="4" placeholder="max%" onChange="calc_determination()" disabled></input></td>
                    </tr>
                    <tr>
                      <td colspan="6" style="padding:8px;">SD&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="determination_sd" name="determination_sd" onChange="calculator()" disabled></td>
                    </tr>
                    <tr>
              ...
              <td colspan="8" style="padding:8px;border-bottom:solid 1px #c4c4ff;">
                <table border="0" width="30%" cellpadding="8px" align="center">
                  <tr>    
                    ...
                    <td style="border-bottom:dottted 1px #c4c4ff;padding:8px;text-align:left;"><input type="radio" name="conclusion" value="1"></input></td>
                    <td style="border-bottom:dottted 1px #c4c4ff;padding:8px;text-align:right;">FAIL</input></td>
                    <td style="border-bottom:dottted 1px #c4c4ff;padding:8px;text-align:left;"><input type="radio" name="conclusion" value="0"></input></td>
                  </tr>
                </table>
            </tr>
              ...
              <td colspan="8" style="padding:8px;">
                <table  class="table_form"border="0" width="100%" cellpadding="8px" align="center">
                  ...
                  <tr>
                    ...
                    <td style="border-bottom: dotted 1px #c4c4ff;padding:8px;text-align:right;">Date Approved <input type="date"  id="date" name="date_appproved"></td>
                  </tr>
                  <tr>
