        ...
        return $('\
           ...
           <tr>\
            ...
            <tr>\
              ...
              <td style="padding:4px;border-bottom: solid 1px #c4c4ff;background-color:#ffffff;text-align: center;" ><input  id="submit" class="btn" type="submit" name="submit" value="Submit"></td>\
              ...
              <td colspan="8" style="padding:8px;">
                <table width="90%" class="inner_table" border="0" cellpadding="8px" align="center">
                  ...
                  <tr>
                    ...
                    <td style="text-align:left;padding:8px;border-bottom: dotted 1px #c4c4ff;background-color: #ffffff;"><input type="text" name="column_oven_temperature"></input></td>
                  </tr>
                  <tr>
                ...
                <td colspan="8" style="padding:8px;">
                  ...
                  <table border="0" class="inner_table" cellpadding="8px" align="center">
                    ...
                    <tr>
                      ...
                      <td><input type="text" id="internal_std_a_one" name="internal_std_one_one"></input></td>
                      <td><input type="text" id="ratio_std_a_one" name="ratio_std_one_one"></input></td>

                      <td><input type="text" id="sample_one_one" name="sample_one_one"></input></td>
                      <td><input type="text" id="internal_std_b_one" name="internal_std_one_two"></input></td>
                      <td><input type="text" id="ratio_std_b_one" name="ratio_std_two_one"></input></td>

                      <td><input type="text" id="sample_one_two" name="sample_one_two"></input></td>
                      <td><input type="text" id="internal_std_c_one" name="internal_std_one_three"></input></td>
                      <td><input type="text" id="ratio_std_c_one" name="ratio_std_one_three"></input></td>

                      <td><input type="text" id="sample_one_three" name="sample_one_three"></input></td>
                      <td><input type="text" id="internal_std_d_one" name="internal_std_one_four"></input></td>
                      <td><input type="text" id="ratio_std_d_one" name="ratio_std_one_four"></input></td>

                      <td><input type="text" id="sample_one_four" name="sample_one_four"></input></td>
                      <td><input type="text" id="internal_std_e_one" name="internal_std_one_five"></input></td>
                      <td><input type="text" id="ratio_std_e_one" name="ratio_std_one_five"></input></td>

                      <td><input type="text" id="sample_one_five" name="sample_one_five"></input></td>
                      <td><input type="text" id="internal_std_f_one" name="internal_std_one_six"></input></td>
                      <td><input type="text" id="ratio_std_f_one" name="ratio_std_one_six"></input></td>

                      <td><input type="text" id="sample_one_six" name="sample_one_six"></input></td>
                      <td><input type="text" id="internal_std_g_one" name="internal_std_one_seven"></input></td>
                      <td><input type="text" id="ratio_std_g_one" name="ratio_std_one_seven"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">2.</td>
                      <td><input type="text" id="std_two" name="std_two" onChange="calc_avg_std()"></input></td>
                      <td><input type="text" id="internal_std_a_two" name="internal_std_two_one" onChange="calc_internal_std()"></input></td>
                      <td><input type="text" id="ratio_std_a_two" name="ratio_std_two_one" onChange="calc_ratio_std()"></input></td>

                      <td><input type="text" id="sample_two_one" name="sample_two_one" onChange="calc_avg_sample_one()"></input></td>
                      <td><input type="text" id="internal_std_b_two" name="internal_std_two_two" onChange="calc_internal_std_two()"></input></td>
                      <td><input type="text" id="ratio_std_b_two" name="ratio_std_two_two" onChange="calc_ratio_std_two()"></input></td>

                      <td><input type="text" id="sample_two_two" name="sample_two_two" onChange="calc_avg_sample_two()"></input></td>
                      <td><input type="text" id="internal_std_c_two" name="internal_std_two_three" onChange="calc_internal_std_three()"></input></td>
                      <td><input type="text" id="ratio_std_c_two" name="ratio_std_three_two" onChange="calc_ratio_std_three()"></input></td>

                      <td><input type="text" id="sample_two_three" name="sample_two_three" onChange="calc_avg_sample_three()"></input></td>
                      <td><input type="text" id="internal_std_d_two" name="internal_std_two_four" onChange="calc_internal_std_four()"></input></td>
                      <td><input type="text" id="ratio_std_d_two" name="ratio_std_two_four" onChange="calc_ratio_std_four()"></input></td>


                      <td><input type="text" id="sample_two_four" name="sample_two_four" onChange="calc_avg_sample_four()"></input></td>
                      <td><input type="text" id="internal_std_e_two" name="internal_std_two_five" onChange="calc_internal_std_five()"></input></td>
                      <td><input type="text" id="ratio_std_e_two" name="ratio_std_two_five" onChange="calc_ratio_std_five()"></input></td>

                      <td><input type="text" id="sample_two_five" name="sample_two_five" onChange="calc_avg_sample_five()"></input></td>
                      <td><input type="text" id="internal_std_f_two" name="internal_std_two_six" onChange="calc_internal_std_six()"></input></td>
                      <td><input type="text" id="ratio_std_f_two" name="ratio_std_two_six" onChange="calc_ratio_std_six()"></input></td>

                      <td><input type="text" id="sample_two_six" name="sample_two_six" onChange="calc_avg_sample_six)"></input></td>
                      <td><input type="text" id="internal_std_g_two" name="internal_std_two_seven" onChange="calc_internal_std_seven()"></input></td>
                      <td><input type="text" id="ratio_std_g_two" name="ratio_std_two_seven" onChange="calc_ratio_std_seven()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">3.</td>
                      <td><input type="text" id="std_three" name="std_three" onChange="calc_avg_std()"></input></td>
                      <td><input type="text" id="internal_std_a_three" name="internal_std_three_one" onChange="calc_internal_std()"></input></td>
                      <td><input type="text" id="ratio_std_a_three" name="ratio_std_three_one" onChange="calc_ratio_std()"></input></td>

                      <td><input type="text" id="sample_three_one" name="sample_three_one" onChange="calc_avg_sample_one()"></input></td>
                      <td><input type="text" id="internal_std_b_three" name="internal_std_three_two" onChange="calc_internal_std_two()"></input></td>
                      <td><input type="text" id="ratio_std_b_three" name="ratio_std_two_three" onChange="calc_ratio_std_two()"></input></td>

                      <td><input type="text" id="sample_three_two" name="sample_three_two" onChange="calc_avg_sample_two()"></input></td>
                      <td><input type="text" id="internal_std_c_three" name="internal_std_three_three" onChange="calc_internal_std_three()"></input></td>
                      <td><input type="text" id="ratio_std_c_three" name="ratio_std_three_three" onChange="calc_ratio_std_three()"></input></td>

                      <td><input type="text" id="sample_three_three" name="sample_three_three" onChange="calc_avg_sample_three()"></input></td>
                      <td><input type="text" id="internal_std_d_three" name="internal_std_three_four" onChange="calc_internal_std_four()"></input></td>
                      <td><input type="text" id="ratio_std_d_three" name="ratio_std_three_four" onChange="calc_ratio_std_four()"></input></td>

                      <td><input type="text" id="sample_three_four" name="sample_three_four" onChange="calc_avg_sample_four()"></input></td>
                      <td><input type="text" id="internal_std_e_three" name="internal_std_three_five" onChange="calc_internal_std_five()"></input></td>
                      <td><input type="text" id="ratio_std_e_three" name="ratio_std_three_five" onChange="calc_ratio_std_five()"></input></td>

                      <td><input type="text" id="sample_three_five" name="sample_three_five" onChange="calc_avg_sample_five()"></input></td>
                      <td><input type="text" id="internal_std_f_three" name="internal_std_three_six" onChange="calc_internal_std_six()"></input></td>
                      <td><input type="text" id="ratio_std_f_three" name="ratio_std_three_six" onChange="calc_ratio_std_six()"></input></td>

                      <td><input type="text" id="sample_three_six" name="sample_three_six" onChange="calc_avg_sample_six()"></input></td>
                      <td><input type="text" id="internal_std_g_three" name="internal_std_three_seven" onChange="calc_internal_std_seven()"></input></td>
                      <td><input type="text" id="ratio_std_g_three" name="ratio_std_three_seven" onChange="calc_ratio_std_seven()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">4.</td>
                      <td><input type="text" id="std_four" name="std_four" onChange="calc_avg_std()"></input></td>
                      <td><input type="text" id="internal_std_a_four" name="internal_std_four_one" onChange="calc_internal_std()"></input></td>
                      <td><input type="text" id="ratio_std_a_four" name="ratio_std_four_one" onChange="calc_ratio_std()"></input></td>

                      <td><input type="text" id="sample_four_one" name="sample_four_one" onChange=" calc_avg_sample_one()"></input></td>
                      <td><input type="text" id="internal_std_b_four" name="internal_std_four_two" onChange="calc_internal_std_two()"></input></td>
                      <td><input type="text" id="ratio_std_b_four" name="ratio_std_four_two" onChange="calc_ratio_std_two()"></input></td>

                      <td><input type="text" id="sample_four_two" name="sample_four_two" onChange="calc_avg_sample_two()"></input></td>
                      <td><input type="text" id="internal_std_c_four" name="internal_std_three_four" onChange="calc_internal_std_three()"></input></td>
                      <td><input type="text" id="ratio_std_c_four" name="ratio_std_four_three" onChange="calc_ratio_std_three()"></input></td>

                      <td><input type="text" id="sample_four_three" name="sample_four_three" onChange="calc_avg_sample_three()"></input></td>
                      <td><input type="text" id="internal_std_d_four" name="internal_std_four_four" onChange="calc_internal_std_four()"></input></td>
                      <td><input type="text" id="ratio_std_d_four" name="ratio_std_four_four" onChange="calc_ratio_std_four()"></input></td>

                      <td><input type="text" id="sample_four_four" name="sample_four_four" onChange="calc_avg_sample_four()"></input></td>
                      <td><input type="text" id="internal_std_e_four" name="internal_std_four_five" onChange="calc_internal_std_five()"></input></td>
                      <td><input type="text" id="ratio_std_e_four" name="ratio_std_four_five" onChange="calc_ratio_std_five()"></input></td>

                      <td><input type="text" id="sample_four_five" name="sample_four_five" onChange="calc_avg_sample_five()"></input></td>
                      <td><input type="text" id="internal_std_f_four" name="internal_std_four_six" onChange="calc_internal_std_six()"></input></td>
                      <td><input type="text" id="ratio_std_f_four" name="ratio_std_four_six" onChange="calc_ratio_std_six()"></input></td>

                      <td><input type="text" id="sample_four_six" name="sample_four_six" onChange="calc_avg_sample_six()"></input></td>
                      <td><input type="text" id="internal_std_g_four" name="internal_std_four_seven" onChange="calc_internal_std_seven()"></input></td>
                      <td><input type="text" id="ratio_std_g_four" name="ratio_std_four_seven" onChange="calc_ratio_std_seven()"></input></td>
                    </tr>
                    <tr>
                      <td style="text-align:center;border-bottom:solid 1px #c4c4ff;">5.</td>
                      <td><input type="text" id="std_five" name="std_five" onChange="calc_avg_std()"></input></td>
                      <td><input type="text" id="internal_std_a_five" name="internal_std_five_one" onChange="calc_internal_std()"></input></td>
                      <td><input type="text" id="ratio_std_a_five" name="ratio_std_five_one" onChange="calc_ratio_std()"></input></td>

                      <td><input type="text" id="sample_five_one" name="sample_five_one" onChange=" calc_avg_sample_one()"></input></td>
                      <td><input type="text" id="internal_std_b_five" name="internal_std_five_two" onChange="calc_internal_std_two()"></input></td>
                      <td><input type="text" id="ratio_std_b_five" name="ratio_std_five_two" onChange="calc_ratio_std_two()"></input></td>

                      <td><input type="text" id="sample_five_two" name="sample_five_two" onChange="calc_avg_sample_two()"></input></td>
                      <td><input type="text" id="internal_std_c_five" name="internal_std_five_three" onChange="calc_internal_std_three()"></input></td>
                      <td><input type="text" id="ratio_std_c_five" name="ratio_std_five_three" onChange="calc_ratio_std_three()"></input></td>

                      <td><input type="text" id="sample_five_three" name="sample_five_three" onChange="calc_avg_sample_three()"></input></td>
                      <td><input type="text" id="internal_std_d_five" name="internal_std_five_four" onChange="calc_internal_std_four()"></input></td>
                      <td><input type="text" id="ratio_std_d_five" name="ratio_std_five_four" onChange="calc_ratio_std_four()"></input></td>


                      <td><input type="text" id="sample_five_four" name="sample_five_four" onChange="calc_avg_sample_four()"></input></td>
                      <td><input type="text" id="internal_std_e_five" name="internal_std_five_five" onChange="calc_internal_std_five()"></input></td>
                      <td><input type="text" id="ratio_std_e_five" name="ratio_std_five_five" onChange="calc_ratio_std_five()"></input></td>

                      <td><input type="text" id="sample_five_five" name="sample_five_five" onChange="calc_avg_sample_five()"></input></td>
                      <td><input type="text" id="internal_std_f_five" name="internal_std_five_six" onChange="calc_internal_std_six()"></input></td>
                      <td><input type="text" id="ratio_std_f_five" name="ratio_std_five_six" onChange="calc_ratio_std_six()"></input></td>

                      <td><input type="text" id="sample_five_six" name="sample_five_six" onChange="calc_avg_sample_six()"></input></td>
                      <td><input type="text" id="internal_std_g_five" name="internal_std_five_seven" onChange="calc_internal_std_seven()"></input></td>
                      <td><input type="text" id="ratio_std_g_five" name="ratio_std_five_seven" onChange="calc_ratio_std_seven()"></input></td>
                    ...
                    <tr>
                      ...
                      <td><input type="text" id="internal_std_a_average" name="internal_std_average" onChange=""></input></td>
                      <td><input type="text" id="ratio_std_a_average" name="ratio_std_one_average" onChange=""></input></td>

                      <td><input type="text" id="sample_one_average" name="sample_one_average" onChange=""></input></td>
                      <td><input type="text" id="internal_std_b_average" name="internal_std_two_average" onChange=""></input></td>
                      <td><input type="text" id="ratio_std_b_average" name="ratio_std_two_average" onChange=""></input></td>

                      <td><input type="text" id="sample_two_average" name="sample_two_average" onChange=""></input></td>
                      <td><input type="text" id="internal_std_c_average" name="internal_std_three_average" onChange=""></input></td>
                      <td><input type="text" id="ratio_std_c_average" name="ratio_std_three_average" onChange=""></input></td>

                      <td><input type="text" id="sample_three_average" name="sample_three_average"></input onChange=""></td>
                      <td><input type="text" id="internal_std_d_average" name="internal_std_four_average" onChange=""></input></td>
                      <td><input type="text" id="ratio_std_d_average" name="ratio_std_four_average" onChange=""></input></td>


                      <td><input type="text" id="sample_four_average" name="sample_four_average" onChange=""></input></td>
                      <td><input type="text" id="internal_std_e_average" name="internal_std_five_average" onChange=""></input></td>
                      <td><input type="text" id="ratio_std_e_average" name="ratio_std_five_average" onChange=""></input></td>

                      <td><input type="text" id="sample_five_average" name="sample_five_average" onChange=""></input></td>
                      <td><input type="text" id="internal_std_f_average" name="internal_std_six_average" onChange=""></input></td>
                      <td><input type="text" id="ratio_std_f_average" name="ratio_std_six_average" onChange=""></input></td>

                      <td><input type="text" id="sample_six_average" name="sample_six_average" onChange=""></input></td>
                      <td><input type="text" id="internal_std_g_average" name="internal_std_seven_average" onChange=""></input></td>
                      <td><input type="text" id="ratio_std_g_average" name="ratio_std_seven_average" onChange=""></input></td>
              ...
              <tr>
                <td colspan="8" style="padding:8px;">
                  <table border="0" width="80%" cellpadding="8" align="center">
                    ...
                    <tr>
                      <td colspan="2" style="padding:8px;text-align:center;"><input type="text" id="d_one_pkstd" name="d_one_pkstd" placeholder="(PKSTD RATIO)" size="5"> x <input type="text" id="d_one_wt" name="d_one_wt" placeholder="(WT)" size="5"> x <input type="text" id="d_one_lc" name="d_one_lc" placeholder="(LC)" size="5" onCHange="calc_determination()"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="3" style="padding:8px;">Average % &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="determination_average" name="determination_average" onChange="calculator()"></input></td>
                    </tr>
                    <tr>
                      <td colspan="6" style="padding:8px;">Equivalent To &nbsp;<input type="text" name="determination_equivalent_to"></input></td>
                    </tr>
                    <tr>
                      <td colspan="6" style="padding:8px;">SD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="determination_sd" name="determination_sd" onChange="calculator()"></input></td>
                    </tr>
                    <tr>
                      <td colspan="6" style="padding:8px;">RSD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="determination_rsd" name="determination_rsd" onChange="calculator()"></input></td>
                    </tr>
                  </table>
                </td>
            </tr>
