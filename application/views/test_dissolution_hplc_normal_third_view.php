...
<div id="form_wrapper">
<div id="forms">
<?php echo form_open('test_dissolution/worksheet_normal_third_hplc', array('id'=>'test_dissolution_view'));?>
...
<table width="950" class="table_form" border="0" cellpadding="4px" align="center">
     <input type="hidden" name ="assignment" value ="<?php echo $assignment;?>"><input type="hidden" name ="test_request" value ="<?php echo $test_request;?>">
      ...
      <input type = "hidden" name "id" value = "<?php echo $sql_dissolution['id']?>"> 
    ...
    <tr>
      ...
      <tr>
       ...
       <tr>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of standard + container (g)</td>
      ...
      <tr>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of container (g) </td>
      ...
      <tr>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Weight of standard (g)</td>
      ...
      <tr>
        ...
        <td colspan ="4"align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="column_pressure"value = "<?php echo $sql_dissolution['column_pressure']?>"> <select name="column_pressure_select"><option value="<?php echo $sql_dissolution['column_pressure_select']?>"></option><option value="Bar">Bar</option><option value="MPA">MPA</option><option value="PSI">PSI</option></select> </td>            
      </tr>
      <tr>  
        ...
        <td colspan ="4"align="left"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="column_oven_pressure"value = "<?php echo $sql_dissolution['column_oven_temp']?>"><select name="column_oven_pressure_select"><option value="<?php echo $sql_dissolution['column_oven_temp_select']?>"></option><option value="C">Celsius</option> <option value="F">Fahrenheit</option></select> </td>       
      </tr>
      <tr>
        ...
        <td colspan ="4"align="left"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="flow_rate"value = "<?php echo $sql_dissolution['flow_rate']?>"> ml/min</td>       
      </tr>
      <tr>
        ...
        <td colspan ="6">
           <table border="0" align="center" class ="inner_table" cellpadding="8px" width="80%">       
            ...
            <tr>
              ...
              <td style="padding: 8px;"><input type = "text" name ="rt_2" id ="rt_2" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['rt_2']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="peak_area_2" id ="peak_area_2" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['peak_area_2']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="asymmetry_2" id="asymmetry_2" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['asymmetry_2']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="resolution_2" id ="resolution_2" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['resolution_2']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="other_2" id ="other_2" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['other_2']?>"></td>
            </tr>
            <tr>
              <td align="center"style="padding: 8px;">3.</td>
              <td style="padding: 8px;"><input type = "text" name ="rt_3" id ="rt_3" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['rt_3']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="peak_area_3" id ="peak_area_3" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['peak_area_3']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="asymmetry_3" id="asymmetry_3" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['asymmetry_3']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="resolution_3" id ="resolution_3" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['resolution_3']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="other_3" id ="other_3" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['other_3']?>"></td>
            </tr>
            <tr>
              <td align="center"style="padding: 8px;">4.</td>
              <td style="padding: 8px;"><input type = "text" name ="rt_4" id ="rt_4"onchange="calculation_average(); calculation_sd()"  value = "<?php echo $sql_dissolution['rt_4']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="peak_area_4" id ="peak_area_4"onchange="calculation_average(); calculation_sd()"  value = "<?php echo $sql_dissolution['peak_area_4']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="asymmetry_4" id="asymmetry_4"onchange="calculation_average(); calculation_sd()"  value = "<?php echo $sql_dissolution['asymmetry_4']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="resolution_4" id ="resolution_4"onchange="calculation_average(); calculation_sd()"  value = "<?php echo $sql_dissolution['resolution_4']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="other_4" id ="other_4"onchange="calculation_average(); calculation_sd()"  value = "<?php echo $sql_dissolution['other_4']?>"></td>
            </tr>
            <tr>
              <td align="center"style="padding: 8px;">5.</td>
              <td style="padding: 8px;"><input type = "text" name ="rt_5" id="rt_5" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['rt_5']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="peak_area_5" id ="peak_area_5" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['peak_area_5']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="asymmetry_5" id="asymmetry_5" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['asymmetry_5']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="resolution_5" id ="resolution_5" vonchange="calculation_average(); calculation_sd()" alue = "<?php echo $sql_dissolution['resolution_5']?>"></td>
              <td style="padding: 8px;"><input type = "text" name ="other_5" id ="other_5" onchange="calculation_average(); calculation_sd()" value = "<?php echo $sql_dissolution['other_5']?>"></td>
            </tr>
            <tr>
      ...
      <tr><td align="left" colspan ="6" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;color:#0000fb;" ><b>Peak Area from chromatograms - </b></td>
       ...
       <tr>
        <td colspan="6" style="padding: 8px; color:#0000fb;"><b>Data collected from Stage one (S1) and Stage two(S2):</b><input type="button" id="sample_data" value="+" class ="btn" size="20" /></td>
      </tr>
       <tr>
        <td colspan ="6">
      ...
      <tr> 
        <td align="center" colspan = "4"style="padding: 12px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <b><u>Determination 23</u></b></td>
        <td align="center" colspan = "2"style="padding: 12px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"></td>
      </tr> 
      <tr>  
        <td colspan ="4" align ="center" style="padding: 12px;">
      ...
      <tr>
        <td align="center" colspan = "4"style="padding: 12px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <b><u>Determination 24</u></b></td>
        <td align="center" colspan = "2"style="padding: 12px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"></td>
      </tr>
      <tr>
        <td colspan ="4" align ="center" style="padding: 12px;">
