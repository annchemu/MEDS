...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <script>
       ...
       function standard_weight_calc_7(){
        var total = document.getElementById('standard_container_7').value - document.getElementById('container_7').value;
        document.getElementById('standard_weight_7').value = total;
       }
       ...
       function sample_average_retention_time(){
        var total = parseInt(document.getElementById('sample_rt_1').value) + parseInt(document.getElementById('sample_rt_2').value)+
                    parseInt(document.getElementById('sample_rt_3').value) + parseInt(document.getElementById('sample_rt_4').value)+
                    parseInt(document.getElementById('sample_rt_5').value) + parseInt(document.getElementById('sample_rt_6').value);
        document.getElementById('sample_rt_avg').value = (total)/6;
       }

       function sample_average_peak_area(){
        var total = parseInt(document.getElementById('sample_peak_area_1').value) + parseInt(document.getElementById('sample_peak_area_2').value)+
                    parseInt(document.getElementById('sample_peak_area_3').value) + parseInt(document.getElementById('sample_peak_area_4').value)+
                    parseInt(document.getElementById('sample_peak_area_5').value) + parseInt(document.getElementById('sample_peak_area_6').value);
                    document.getElementById('sample_peak_area_avg').value = (total)/6;
       }

       function sample_average_asymmetry(){
        var total = parseInt(document.getElementById('sample_asymmetry_1').value) + parseInt(document.getElementById('sample_asymmetry_2').value)+
                    parseInt(document.getElementById('sample_asymmetry_3').value) + parseInt(document.getElementById('sample_asymmetry_4').value)+
                    parseInt(document.getElementById('sample_asymmetry_5').value) + parseInt(document.getElementById('sample_asymmetry_6').value);
                    document.getElementById('sample_asymmetry_avg').value = (total)/6;
       }

       function sample_average_theoretical(){
        var total = parseInt(document.getElementById('sample_theoretical_1').value) + parseInt(document.getElementById('sample_theoretical_2').value)+
                    parseInt(document.getElementById('sample_theoretical_3').value) + parseInt(document.getElementById('sample_theoretical_4').value)+
                    parseInt(document.getElementById('sample_theoretical_5').value) + parseInt(document.getElementById('sample_theoretical_6').value);
                    document.getElementById('sample_theoretical_avg').value = (total)/6;
       }
    
       function sample_average_resolution(){
        var total = parseInt(document.getElementById('sample_resolution_1').value) + parseInt(document.getElementById('sample_resolution_2').value)+
                    parseInt(document.getElementById('sample_resolution_3').value) + parseInt(document.getElementById('sample_resolution_4').value)+
                    parseInt(document.getElementById('sample_resolution_5').value) + parseInt(document.getElementById('sample_resolution_6').value);
                    document.getElementById('sample_resolution_avg').value = (total)/6;
       }

       function sample_average_rrt(){
        var total = parseInt(document.getElementById('sample_rrt_1').value) + parseInt(document.getElementById('sample_rrt_2').value)+
                    parseInt(document.getElementById('sample_rrt_3').value) + parseInt(document.getElementById('sample_rrt_4').value)+
                    parseInt(document.getElementById('sample_rrt_5').value) + parseInt(document.getElementById('sample_rrt_6').value);
        document.getElementById('sample_rrt_avg').value = (total)/6;
       }
      ...
      function sample_sd_retention_time(){
        var average_retention_time = (parseInt(document.getElementById('sample_rt_1').value) + parseInt(document.getElementById('sample_rt_2').value)+parseInt(document.getElementById('sample_rt_3').value) + parseInt(document.getElementById('sample_rt_4').value)+parseInt(document.getElementById('sample_rt_5').value) + parseInt(document.getElementById('sample_rt_6').value))/6;
        var samples_retention_time = [parseInt(document.getElementById('sample_rt_1').value), parseInt(document.getElementById('sample_rt_2').value),parseInt(document.getElementById('sample_rt_3').value), parseInt(document.getElementById('sample_rt_4').value),parseInt(document.getElementById('sample_rt_5').value), parseInt(document.getElementById('sample_rt_6').value)];            
        var variance_retention_time=0;
        ...
        for(var i=0;i<samples_retention_time.length; i++){
         ...
         var standard_deviation_retention_time= Math.sqrt((variance_retention_time)/i);
         document.getElementById('sample_rt_sd').value = standard_deviation_retention_time;
       }
       function sample_sd_peak_area(){
        var average_peak_area = (parseInt(document.getElementById('sample_peak_area_1').value) + parseInt(document.getElementById('sample_peak_area_2').value)+parseInt(document.getElementById('sample_peak_area_3').value) + parseInt(document.getElementById('peak_area_4').value)+parseInt(document.getElementById('sample_peak_area_5').value)+parseInt(document.getElementById('sample_peak_area_6').value))/6;
        var samples_peak_area = [parseInt(document.getElementById('sample_peak_area_1').value), parseInt(document.getElementById('sample_peak_area_2').value), parseInt(document.getElementById('sample_peak_area_3').value) + parseInt(document.getElementById('peak_area_4').value), parseInt(document.getElementById('sample_peak_area_5').value) + parseInt(document.getElementById('sample_peak_area_6').value)];
        var variance_peak_area = 0;
        ...
        for(var i=0;i<samples_peak_area.length; i++){
          ...
          var standard_deviation_peak_area= Math.sqrt((variance_peak_area)/i);
          document.getElementById('sample_peak_area_sd').value = standard_deviation_peak_area;
       }
       function sample_sd_asymmetry(){
        var average_asymmetry = (parseInt(document.getElementById('sample_asymmetry_1').value) + parseInt(document.getElementById('sample_asymmetry_2').value)+parseInt(document.getElementById('sample_asymmetry_3').value) + parseInt(document.getElementById('sample_asymmetry_4').value)+parseInt(document.getElementById('sample_asymmetry_5').value) + parseInt(document.getElementById('sample_asymmetry_6').value))/6;
        var samples_asymmetry =[parseInt(document.getElementById('sample_asymmetry_1').value), parseInt(document.getElementById('sample_asymmetry_2').value), parseInt(document.getElementById('sample_asymmetry_3').value), parseInt(document.getElementById('sample_asymmetry_4').value), parseInt(document.getElementById('sample_asymmetry_5').value), parseInt(document.getElementById('sample_asymmetry_6').value)];
        var variance_asymmetry =0;
        ...
        for(var i=0;i<samples_asymmetry.length; i++){
         ...
         var standard_deviation_asymmetry= Math.sqrt((variance_asymmetry)/i);
         document.getElementById('sample_asymmetry_sd').value = standard_deviation_asymmetry;
       }
       function sample_sd_resolution(){
        var average_resolution = (parseInt(document.getElementById('sample_resolution_1').value) + parseInt(document.getElementById('sample_resolution_2').value)+ parseInt(document.getElementById('sample_resolution_3').value) + parseInt(document.getElementById('sample_resolution_4').value)+ parseInt(document.getElementById('sample_resolution_5').value) + parseInt(document.getElementById('sample_resolution_6').value))/6;
        var samples_resolution = [parseInt(document.getElementById('sample_resolution_1').value), parseInt(document.getElementById('sample_resolution_2').value),parseInt(document.getElementById('sample_resolution_3').value), parseInt(document.getElementById('sample_resolution_4').value),parseInt(document.getElementById('sample_resolution_5').value), parseInt(document.getElementById('sample_resolution_6').value)];
        var variance_resolution=0;
       ...
       for(var i=0;i<samples_resolution.length; i++){
        ...
        var standard_deviation_resolution= Math.sqrt((variance_resolution)/i);
        document.getElementById('sample_resolution_sd').value = standard_deviation_resolution;
      }
      function sample_sd_theoretical(){
        var average_theoretical = (parseInt(document.getElementById('sample_theoretical_1').value) + parseInt(document.getElementById('sample_theoretical_2').value)+parseInt(document.getElementById('sample_theoretical_3').value) + parseInt(document.getElementById('sample_theoretical_4').value)+parseInt(document.getElementById('sample_theoretical_5').value) + parseInt(document.getElementById('sample_theoretical_6').value))/6;
        var samples_theoretical =[parseInt(document.getElementById('sample_theoretical_1').value), parseInt(document.getElementById('sample_theoretical_2').value), parseInt(document.getElementById('sample_theoretical_3').value), parseInt(document.getElementById('sample_theoretical_4').value), parseInt(document.getElementById('sample_theoretical_5').value), parseInt(document.getElementById('sample_theoretical_6').value)];
        var variance_theoretical =0;

        for(var i=0;i<samples_theoretical.length; i++){
           variance_theoretical += Math.pow((samples_theoretical [i]-average_theoretical),2);         
         }
         var standard_deviation_theoretical= Math.sqrt((variance_theoretical)/i);
         document.getElementById('sample_theoretical_sd').value = standard_deviation_theoretical;
       }
       function sample_sd_rrt(){
        var average_rrt = (parseInt(document.getElementById('sample_rrt_1').value) + parseInt(document.getElementById('sample_rrt_2').value)+ parseInt(document.getElementById('sample_rrt_3').value) + parseInt(document.getElementById('sample_rrt_4').value)+ parseInt(document.getElementById('sample_rrt_5').value) + parseInt(document.getElementById('sample_rrt_6').value))/6;
        var samples_rrt = [parseInt(document.getElementById('sample_rrt_1').value), parseInt(document.getElementById('sample_rrt_2').value),parseInt(document.getElementById('sample_rrt_3').value), parseInt(document.getElementById('sample_rrt_4').value),parseInt(document.getElementById('sample_rrt_5').value), parseInt(document.getElementById('sample_rrt_6').value)];
        var variance_rrt=0;
      
       for(var i=0;i<samples_rrt.length; i++){
           variance_rrt += Math.pow((samples_rrt [i]-average_rrt),2);         
         }

        var standard_deviation_rrt= Math.sqrt((variance_rrt)/i);
        document.getElementById('sample_rrt_sd').value = standard_deviation_rrt;
      }
   ...
   <input type="hidden" name ="assignment" value ="<?php echo $assignment;?>"><input type="hidden" name ="test_request" value ="<?php echo $test_request;?>">
    ...
    <tr>
      ...
      <tr>
        ...
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['reagents'];?></td>
        <td align="left"  style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['reagents_2'];?></td>
        <td align="left"  style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['reagents_3'];?></td>
        <td align="left"  style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['reagents_4'];?></td>        
       ...
       <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['standard_container_5'];?></td>          
        ...
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['standard_container_7'];?></td> 
      </tr>
      <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['container_5'];?></td>
        ...
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['container_7'];?> </td>
      </tr>
      <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['standard_weight_4'];?></td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['standard_weight_5'];?></td>
        ...
        <td colspan = "2" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['standard_weight_7'];?></td>
      <tr>
       ...
       <tr>
        <td colspan = "6"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['mobile_phase'];?></textarea></td>
      </tr>
      <tr>
