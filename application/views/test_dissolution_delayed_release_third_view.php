...
<table width="950" class ="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr>
      ...
      <tr>
        <td colspan="6" style="padding: 8px; color:#0000fb;"><b>Data collected from Stage one (S1): After <?php echo $sql_dissolution['minutes']?> and Stage two(S2): After <?php echo $sql_dissolution['minutes']?></b>  <input type="button" id="sample_data" value="+" class ="btn" size="20" /></td>
      </tr>  
       <tr>
        <td colspan ="6">
