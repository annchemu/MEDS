   ...
   <?php 
    ...
    <table width="950px" bgcolor="#c4c4ff" border="0" cellpadding="4px" align="center">
      ...
      <tr height = "20px">
        ...
        <td  height="5px" align="left" style="background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">
        <b>Investigated by</b></td>
        <td style="background-color:#ffffff;border-right: dotted 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query['investigated_by'];?>
        </td>
      </tr>
      <tr height = "20px">
      ...
      <tr>
        <td colspan="4" align="center" style="background-color:#ffffff;border-right: dotted 1px #bfbfbf;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query['action_taken'];?>
        </td>
      </tr>
    </table>
    </form>
