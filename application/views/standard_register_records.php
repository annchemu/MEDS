    ...
    <div id="account_lists">
        <table  class="subdivider" border="0" bgcolor="#ffffff"  width="100%" cellpadding="8px" align="center">
          <tr>
            ...
            <tr>
                <td align ="left">
                <a href="<?php echo base_url().'standard_register_records/Get';?>" class="current sub_menu sub_menu_link first_link">Records In Use</a>
                ...
                <td align = "right"
                    ...
                    ?>
                ><a href="<?php echo base_url().'standard_register_records/print_records';?>"><img src="<?php echo base_url().'images/icons/pdf.png';?>" height="20px" width="20px">PDF</a>&nbsp;&nbsp;
