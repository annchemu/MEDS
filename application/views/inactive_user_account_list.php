    ...
    <div id="account_lists">
        <table bgcolor="#ffffff" class="subdivider" border="0" width="100%" cellpadding="4px">
            ...
            <tr>
                ...
                <td style="text-align:left;background-color:#ffffff;text-color:#00ff00;" width="140px"><a class ="current"href="<?php echo base_url().'inactive_users/Get';?>">Inactive Accounts</a></td>
                <td style="text-align:left;background-color:#ffffff;text-color:#00ff00;" width="140px"><a href="<?php echo base_url().'deactivated_users/Get';?>">Decativated Accounts</a></td>
                <td style="padding:4px;text-align:right;background-color:#ffffff;text-color:#00ff00;"><a data-target="#new_user_form" class="btn" role="button" data-toggle="modal"><img src="<?php echo base_url().'images/icons/add_client.png'?>" height="20px" width="20px">Add User</a></td>
            </tr>
