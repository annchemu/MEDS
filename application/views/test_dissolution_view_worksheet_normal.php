...
<table width="950" class="table_form" border="0" cellpadding="4px" align="center">
    ...
    <tr>
      ...
      <tr>
        ...
        <td colspan = "" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">Potency: <?php echo $query_e['potency_1'];?></br> </td><td>Lot No.: <?php echo $query_e['lot_no_1'];?> </td><td>ID No.:<?php echo $query_e['id_no_1'];?></td>
       ...
       <tr>
        ...
        <td colspan="4"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"><?php echo $query_e['standard_container_1'];?> <input type ="text" name="standard_container_1" id ="standard_container_1"> </td>      
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan ="3"align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['column_oven_pressure'];?></td> 
      </tr>
      <tr>  
      ...
      <tr>
        ...
        <td colspan ="3"align="left"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <?php echo $query_e['flow_rate'];?></td> 
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="8" style="padding:8px;border-bottom:solid 1px #c4c4ff;"><?php echo $query_e['choice'];?><tr>
