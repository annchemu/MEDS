    ...
    <div id="account_lists" style="display: block" name="menu">
        <table bgcolor="#ffffff" class="subdivider" border="0" width="100%" cellpadding="4px">
            ...
            <tr>
                ...
                <td colspan="2" style="padding:4px;text-align:right;background-color:#ffffff;text-color:#00ff00;"><a data-target="#new_client_form" class="btn" role="button" data-toggle="modal"><img src="<?php echo base_url().'images/icons/add_client.png'?>"/ height="20px" width="20px">Add Client</a></td>
            </tr>
