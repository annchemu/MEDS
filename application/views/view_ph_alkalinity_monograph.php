       ...
       <table class="table_form" width="75%" border="0" cellpadding="4px" align="center">
        ...
        <input type="hidden" name="assignment_id" value="<?php echo $request[0]['a'];?>"></input>
          ...
          <tr>
            ...
            <tr>
              <td colspan="8" align="center" style="padding:4px;border-bottom: solid 1px #c4c4ff;border-top: solid 1px #c4c4ff;color: #0000fb;background-color: #ffffff;"><h5>pH Alkalinity</h5></td>
            </tr>
            <tr>
