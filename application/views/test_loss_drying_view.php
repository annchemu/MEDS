  ...
  <script>
   ...
   function standard_weight_calc(){
       ...
       function standard_weight_calc_2(){
        var total = document.getElementById('potency_standard_container_1').value - document.getElementById('potency_container_1').value;
        document.getElementById('standard_weight_2').value = total;
       }
       function standard_weight_calc_3(){
        var total = document.getElementById('potency_standard_container_2').value - document.getElementById('potency_container_2').value;
        document.getElementById('standard_weight_3').value = total;
       }
       function standard_weight_calc_4(){
        var total = document.getElementById('potency_standard_container_3').value - document.getElementById('potency_container_3').value;
        document.getElementById('standard_weight_4').value = total;
       }
       function determination_calc_1(){
        var upper = (parseInt(document.getElementById('det_1_initial').value) * parseInt(document.getElementById('det_1_weight').value))*100;          
        var total = upper/parseInt(document.getElementById('det_1_initial_weight').value);

                    document.getElementById('determination_1').value = total;
       }
       function determination_calc_2(){
        var upper = (parseInt(document.getElementById('det_2_initial').value) * parseInt(document.getElementById('det_2_weight').value))*100;          
        var total = upper/parseInt(document.getElementById('det_2_initial_weight').value);

                    document.getElementById('determination_2').value = total;
       }
       function determination_calc_3(){
        var upper = (parseInt(document.getElementById('det_3_initial').value) * parseInt(document.getElementById('det_3_weight').value))*100;          
        var total = upper/parseInt(document.getElementById('det_3_initial_weight').value);

                    document.getElementById('determination_3').value = total;
       }
       function determination_calc_4(){
        var upper = (parseInt(document.getElementById('det_4_initial').value) * parseInt(document.getElementById('det_4_weight').value))*100;          
        var total = upper/parseInt(document.getElementById('det_4_initial_weight').value);

                    document.getElementById('determination_4').value = total;
       }
       function determination_calc_5(){
        var upper = (parseInt(document.getElementById('det_5_initial').value) * parseInt(document.getElementById('det_5_weight').value))*100;          
        var total = upper/parseInt(document.getElementById('det_5_initial_weight').value);

                    document.getElementById('determination_5').value = total;
       }
       function determination_calc_6(){
        var upper = (parseInt(document.getElementById('det_6_initial').value) * parseInt(document.getElementById('det_6_weight').value))*600;          
        var total = upper/parseInt(document.getElementById('det_6_initial_weight').value);
...
<input type="hidden" name ="analyst" value ="<?php echo $user['logged_in']['fname']." ".$user['logged_in']['lname'];?>">
    ...
    <tr>
      ...
      <tr>
        ...
        <td colspan ="3" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <textarea rows ="4" cols ="50" name ="standard_dilution"></textarea>  </td>
      </tr>
       <tr>
      ...
      <tr>
       ...
       <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="potency_standard_container_1" id ="potency_standard_container_1"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="potency_standard_container_2" id ="potency_standard_container_2"> </td>
        <td colspan = "3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="potency_standard_container_3" id ="potency_standard_container_3"> </td>
      </tr>
      <tr>
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="potency_container_1" id ="potency_container_1" onchange ="standard_weight_calc_2()"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="potency_container_2" id ="potency_container_2" onchange ="standard_weight_calc_3()"> </td>
        <td colspan = "3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="potency_container_3" id ="potency_container_3" onchange ="standard_weight_calc_4()"> </td>
      </tr>
      <tr>  
        ...
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="standard_weight_2" id ="standard_weight_2"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="standard_weight_3" id ="standard_weight_3"> </td>
        <td colspan = "3" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="standard_weight_4" id ="standard_weight_4"> </td>
      </tr>
      <tr>  
      ...
      <tr>  
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">1.</td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_11"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_12"> </td>
        <td colspan = "3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_13"> </td>
      </tr>
      <tr>  
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">2.</td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_21"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_22"> </td>
        <td colspan = "3"style="padding: 8px;background-color:#ffffff;border-bottom: dotted 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_23"> </td>
      </tr>
      <tr>  
        <td align="left" style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;">3.</td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_31"> </td>
        <td style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_32"> </td>
        <td colspan = "3"style="padding: 8px;background-color:#ffffff;border-bottom: solid 1px #bfbfbf;border-top: dotted 1px #bfbfbf;"> <input type ="text" name="time_33"> </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan ="4" align ="center" style="padding: 12px;">
          [<input type ="text" name="det_1_initial" id ="det_1_initial"size ="10" placeholder="INITIAL">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
          <input type ="text" name="det_1_weight" id ="det_1_weight"size ="10" placeholder="WEIGHT AFTER DRYING">]&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp*100 <br/><br/>
          <input type ="text" name="det_1_initial_weight" id ="det_1_initial_weight" size ="10" placeholder="INITIAL WEIGHT" onchange="determination_calc_1()"></td>        
      ...
      <tr>
        <td colspan ="4" align ="center" style="padding: 12px;">
          [<input type ="text" name="det_2_initial" id ="det_2_initial"size ="10" placeholder="INITIAL">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
          <input type ="text" name="det_2_weight" id ="det_2_weight"size ="10" placeholder="WEIGHT AFTER DRYING">]&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp*100 <br/><br/>
          <input type ="text" name="det_2_initial_weight" id ="det_2_initial_weight" size ="10" placeholder="INITIAL WEIGHT" onchange="determination_calc_2()"></td>        
      ...
      <tr>  
        <td colspan ="4" align ="center" style="padding: 12px;">
          [<input type ="text" name="det_3_initial" id ="det_3_initial"size ="10" placeholder="INITIAL">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
          <input type ="text" name="det_3_weight" id ="det_3_weight"size ="10" placeholder="WEIGHT AFTER DRYING">]&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp*100 <br/><br/>
          <input type ="text" name="det_3_initial_weight" id ="det_3_initial_weight" size ="10" placeholder="INITIAL WEIGHT" onchange="determination_calc_3()"></td>        
      ...
      <tr>  
        <td colspan ="4" align ="center" style="padding: 12px;">
          [<input type ="text" name="det_4_initial" id ="det_4_initial"size ="10" placeholder="INITIAL">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
          <input type ="text" name="det_4_weight" id ="det_4_weight"size ="10" placeholder="WEIGHT AFTER DRYING">]&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp*100 <br/><br/>
          <input type ="text" name="det_4_initial_weight" id ="det_4_initial_weight" size ="10" placeholder="INITIAL WEIGHT" onchange="determination_calc_4()"></td>        
      ...
      <tr>  
        <td colspan ="4" align ="center" style="padding: 12px;">
          [<input type ="text" name="det_5_initial" id ="det_5_initial"size ="10" placeholder="INITIAL">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
          <input type ="text" name="det_5_weight" id ="det_5_weight"size ="10" placeholder="WEIGHT AFTER DRYING">]&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp*100 <br/><br/>
          <input type ="text" name="det_5_initial_weight" id ="det_5_initial_weight" size ="10" placeholder="INITIAL WEIGHT" onchange="determination_calc_5()"></td>        
      ...
      <tr>  
        <td colspan ="4" align ="center" style="padding: 12px;">
          [<input type ="text" name="det_6_initial" id ="det_6_initial"size ="10" placeholder="INITIAL">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
          <input type ="text" name="det_6_weight" id ="det_6_weight"size ="10" placeholder="WEIGHT AFTER DRYING">]&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp*100 <br/><br/>
          <input type ="text" name="det_6_initial_weight" id ="det_6_initial_weight" size ="10" placeholder="INITIAL WEIGHT" onchange="determination_calc_6()"></td>        
      ...
      <tr>
        <td style ="padding: 8px;"colspan = "6" align ="center"> <input type ="submit" name ="save_loss_dying_hplc" value ="Save Loss Drying Data"></td>
      </tr>
    </table>
   </form> 
 </div>
