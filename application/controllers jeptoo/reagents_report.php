...
class Reagents_Report extends CI_Controller {
	...
	function index() {
		...
		$main_array[] = array('name' => 'Reagents in Use', 'data' => $in_use_data);
		$main_array[] = array('name' => 'Expired Reagents', 'data' => $expired_data);
		$main_array[] = array('name' => 'Damaged Reagents', 'data' => $damaged_data);
		$main_array[] = array('name' => 'Exhausted Reagents', 'data' => $exhausted_data);
