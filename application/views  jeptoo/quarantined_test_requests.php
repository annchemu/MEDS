     ...
     <div id="account_lists">
       <table class="subdivider" border="0" bgcolor="#ffffff" width="100%" cellpadding="8px" align="center">
        <tr>
            ...
            <a href="<?php echo base_url().'test_request_list/GetQ/'.$test_request_id.'/'.$user_type_id;?>"class="current sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/ot.png';?>" height="20px" width="20px">Quarantined Test Requests</a>
            <a
             <?php
      ...
      <table width="100%">
        <tr>
           <td align="center" style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Quarantined Analysis Test Analysis Requests</h5></td>
        </tr>
      </table>
