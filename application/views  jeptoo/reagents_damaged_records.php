 ...
 <body>
  ...
  <div id="form_wrapper_lists">
    <div id="account_lists">
          ...
          <tr>
            <td  align="center"
             ...
             ?>>
                ...
                <a href="<?php echo base_url().'reagents_inventory_record/Damaged';?>" class="current sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/damaged.png';?>" height="25px" width ="25px">Damaged Reagents</a>
             ...
             <?php
               ...
               <a href="<?php echo base_url().'reagents_inventory_record/print_damaged_records';?>"><img src="<?php echo base_url().'images/icons/pdf.png';?>" height="20px" width="20px">PDF</a>
             </td>
               <td align="right"
                   <?php
                      if($user['logged_in']['user_type'] ==5 && $user['logged_in']['department_id']==3){
       ...
       <table width="100%">
          <tr>
            <td align="center" colspan = "4"style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Damaged Reagent Records</h5></td>
          </tr>
       </table>
