    ...
    <div id="account_lists" style="display: block" name="menu">
        <table  class="subdivider" border="0" bgcolor="#ffffff"  width="100%" cellpadding="8px" align="center">
            <tr>
                ...
                <a href="<?php echo base_url().'standard_register_records/getDamaged';?>" class="current sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/damaged.png';?>" height="25px" width ="25px">Damaged Records</a>
                <a href="<?php echo base_url().'standard_register_records/getExhausted';?>" class="sub_menu sub_menu_link first_link"><img src="<?php echo base_url().'images/icons/empty.png';?>" height="20px" width ="20px">Exhausted Records</a>
                <a
               <?php
                 ...
                 ?> href="<?php echo base_url().'standard_register_report/index';?>"><img src="<?php echo base_url().'images/icons/reports.png';?>" height="25px" width ="25px">Reports</a>
                 <a href="<?php echo base_url().'standard_register_records/print_damaged_records';?>"><img src="<?php echo base_url().'images/icons/pdf.png';?>" height="20px" width="20px">PDF</a>
               </td>  
                <td align = "right"
                    <?php
        ...
        <table width="100%">
            <tr>
              <td align="center" colspan ="4"  style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Reference Standard Register Records Damaged</h5></td>
            </tr>
        </table>
