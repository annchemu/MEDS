...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Sample Stores Reports</title>
		...
		<script>
			$(function() {
				$('#container').highcharts({
					...
					title : {
						text : 'Sample Stores Weekly Temperature Summary',
						x : -20 //center
					},
					subtitle : {
				...
				$('#container_humidity').highcharts({
					...
					title : {
						text : 'Sample Stores Weekly Humidity Summary',
						x : -20 //center
					},
					subtitle : {
						text : 'Source: MEDS.com',
	      ...
	      <tr>
	       ...
	       <td style="border-bottom: solid 1px #c4c4ff;padding:2px;text-align: left;background-color: #ffffff;" width="130px">
			...
			<div id="link" style="text-align:right;padding-top:10px;padding:4px;border-bottom: solid 1px #c4c4ff;">
			 <a href="<?php echo base_url().'temperature_humidity_list/records/2';?>"><img src="<?php echo base_url().'images/icons/back.png';?>" height="20px" width="20px"><b>Back to Store Temperature & Humidity List</b></a>
			</div>
