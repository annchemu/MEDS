  ...
  <div id="form_wrapper_lists">
    <div id="account_lists">
        <table class="subdivider" bgcolor="#ffffff" border="0" width="100%" cellpadding="4px">
            <tr>
                <td colspan="4" align="center" style="border-bottom: solid 10px #c4c4ff;color: #0000fb;background-color: #e8e8ff;"><h5>Deactivated Client Records</h5></td>
            </tr>
            <tr>
                ...
                <td style="text-align:left;background-color:#ffffff;text-color:#00ff00;" width="140px"><a  href="<?php echo base_url().'inactive_clients/Get';?>">Inactive Accounts</a></td>
                <td style="text-align:left;background-color:#ffffff;text-color:#00ff00;" width="240px"><a class ="current"href="<?php echo base_url().'deactivated_client_list/Get';?>">Deactivated Accounts</a></td>
                <td align="right"<?php
        ...
        <table id="list" width="100%" class="list_view_header"   bgcolor="#ffffff" cellpadding="4px">
            ...
            ?>
                ...
                <td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php if ($row->status==0){echo "Deactivated";}?></td>
                <td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><?php echo $row->created_at;?></td>
                <td style="text-align: center;border-bottom: solid 1px #c0c0c0;"><a href="<?php echo base_url().'update_client_record/Update/'.$row->id;?>"><img src="../images/icons/client_edit.png" height="20px" width="20px"/>edit</a></td>
             <?php
