...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Instrument Room Reports</title>
		...
		<script>
			$(function() {
				$('#container').highcharts({
					...
					title : {
						text : 'Instrument Room Weekly Temperature Summary',
						x : -20 //center
					},
					subtitle : {
					...
					title : {
						text : 'Instrument Room Weekly Humidity Summary',
						x : -20 //center
					},
					subtitle : {
						text : 'Source: MEDS.com',
...
<body>
	  ...
	  <table  cellpadding="2px" align="center" width="100%">
		...
		<div id="link" style="text-align:right;padding-top:10px;padding:4px;border-bottom: solid 1px #c4c4ff;">
		 <a href="<?php echo base_url().'temperature_humidity_list/records/4';?>"><img src="<?php echo base_url().'images/icons/back.png';?>" height="20px" width="20px">Back to Instrumrnt Room Temperature & Humidity List</a>
		</div>
		<div id="container" style="padding-top:180px;width:100%; height:400px;"></div>
<!--second graph-->
		<div id="container1" style="padding-top:40px;width:100%; height:400px;"></div>
	</body>
</html>