        ...
        <table  class="subdivider" border="0" bgcolor="#ffffff"  width="100%" cellpadding="8px" align="center">
            <tr>
               ...
               <?php
                 ...
                 <a href="<?php echo base_url().'standard_register_records/print_exhausted_records';?>"><img src="<?php echo base_url().'images/icons/pdf.png';?>" height="20px" width="20px">PDF</a>
               </td>  
                <td align = "right"
                    <?php
