...
function index(){
    ...
    $data['friability']=$this->db->select('friability.test_status')->get_where('friability', array('test_request_id' => $trid))->result_array();
    $data['ph_alkalinity']=$this->db->select('ph_alkalinity.status')->get_where('ph_alkalinity', array('test_request_id' => $trid))->result_array();
    ...
    $data['monograph_weight_variation_hplc_two_components']=$this->db->select('uniformity_monograph_weight_variation_two_components.monograph')->get_where('uniformity_monograph_weight_variation_two_components', array('uniformity_monograph_weight_variation_two_components.test_request_id' => $trid))->result_array();
    $data['monograph_content_uniformity_hplc_single_component']=$this->db->select('uniformity_monograp_content_uniformity_single_component.monograph')->get_where('uniformity_monograp_content_uniformity_single_component', array('uniformity_monograp_content_uniformity_single_component.test_request_id' => $trid))->result_array();
    $data['monograph_content_uniformity_hplc_two_components']=$this->db->select('uniformity_monograp_content_uniformity_two_components.monograph')->get_where('uniformity_monograp_content_uniformity_two_components', array('uniformity_monograp_content_uniformity_two_components.test_request_id' => $trid))->result_array();
    $data['monograph_content_uniformity_titration_single_component']=$this->db->select('uniformity_monograp_content_uniformity_titra_single_component.monograph')->get_where('uniformity_monograp_content_uniformity_titra_single_component', array('uniformity_monograp_content_uniformity_titra_single_component.test_request_id' => $trid))->result_array();
    $data['monograph_content_uniformity_titration_two_components']=$this->db->select('uniformity_monograp_content_uniformity_titra_two_components.monograph')->get_where('uniformity_monograp_content_uniformity_titra_two_components', array('uniformity_monograp_content_uniformity_titra_two_components.test_request_id' => $trid))->result_array();
    $data['monograph_content_uniformity_uv_single_component']=$this->db->select('uniformity_monograp_content_uniformity_uv_single_component.monograph')->get_where('uniformity_monograp_content_uniformity_uv_single_component', array('uniformity_monograp_content_uniformity_uv_single_component.test_request_id' => $trid))->result_array();
    $data['monograph_content_uniformity_uv_two_components']=$this->db->select('uniformity_monograp_content_uniformity_uv_two_components.monograph')->get_where('uniformity_monograp_content_uniformity_uv_two_components', array('uniformity_monograp_content_uniformity_uv_two_components.test_request_id' => $trid))->result_array();
    $data['monograph_uniformity_of_dosage_unit_single_component']=$this->db->select('uniformity_of_dosage_monograph_unit_single_component.monograph')->get_where('uniformity_of_dosage_monograph_unit_single_component', array('uniformity_of_dosage_monograph_unit_single_component.test_request_id' => $trid))->result_array();
    $data['monograph_uniformity_of_dosage_unit_two_components']=$this->db->select('uniformity_of_dosage_monograph_unit_two_components.monograph')->get_where('uniformity_of_dosage_monograph_unit_two_components', array('uniformity_of_dosage_monograph_unit_two_components.test_request_id' => $trid))->result_array();
    ...
    $data['assay_monograph_hplc_internal_method_two_components']=$this->db->select('assay_monograph_hplc_internal_method_two_components.monograph')->get_where('assay_monograph_hplc_internal_method_two_components', array('assay_monograph_hplc_internal_method_two_components.test_request_id' => $trid))->result_array(); 
