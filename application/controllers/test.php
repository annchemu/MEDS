...
function index(){
    ...
    $data['assay_ultraviolet']=$this->db->select('assay_ultraviolet.test_status')->get_where('assay_ultraviolet', array('test_request_id' => $trid))->result_array();
    ...
    // $data['content_uniformity_titration_single_component']=$this->db->select('content_uniformity_hplc_single_component.test_status')->get_where('content_uniformity_hplc_single_component', array('test_request_id' => $trid))->result_array();
    // $data['content_uniformity_titration_two_components']=$this->db->select('content_uniformity_hplc_two_components.test_status')->get_where('content_uniformity_hplc_two_components', array('test_request_id' => $trid))->result_array();
