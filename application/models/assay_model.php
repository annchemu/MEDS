...
class Assay_Model extends CI_Model{
   ...
   function process_internal_method(){
    ...
    $data = array(
     ...
     'weight_standard_container_std'=>$this->input->post('weight_standard_container_of_std'),
     'weight_container_of_std'=>$this->input->post('weight_container_of_std'),
     'weight_of_standard'=>$this->input->post('weight_of_standard'),
