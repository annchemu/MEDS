<?php
class Test_Dissolution_Normal_Model extends CI_Model{
...
function save_worksheet(){
	...
	function save_second_worksheet(){
		...
		$test_request=$this->input->post('test_request');
		$assignment=$this->input->post('assignment');
		$test_type='Dissolution Test Normal, Second Stage';
		$analyst= $this->input->post('analyst');
	...
	function save_third_worksheet(){
		...
		$this->db->insert('coa', $coa_data);
			...
			$this->db->insert('diss_normal_hplc_third_samples', $samples_data);
